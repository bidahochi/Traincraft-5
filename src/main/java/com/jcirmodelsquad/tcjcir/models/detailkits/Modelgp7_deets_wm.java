...
public class Modelgp7_deets_wm extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[5] = new ModelRendererTurbo(this, 14, 51, textureX, textureY, "numberboard"); // Box 117 numberboard front wm chop
		bodyModel[6] = new ModelRendererTurbo(this, 14, 51, textureX, textureY, "numberboard"); // Box 118 numberboard front wm chop
		...
		bodyModel[11] = new ModelRendererTurbo(this, 45, 43, textureX, textureY, "marker_wm_chop_body_11"); // Box 559 markerlight wm chop
		bodyModel[12] = new ModelRendererTurbo(this, 45, 43, textureX, textureY, "marker_wm_chop_body_12"); // Box 559 markerlight wm chop
