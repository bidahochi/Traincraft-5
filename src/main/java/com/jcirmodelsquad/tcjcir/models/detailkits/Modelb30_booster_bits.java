...
public class Modelb30_booster_bits extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[21] = new ModelRendererTurbo(this, 231, 227, textureX, textureY, "numberboard"); // Box 388 numberboard booster
		bodyModel[22] = new ModelRendererTurbo(this, 231, 227, textureX, textureY, "numberboard"); // Box 389 numberboard booster
		bodyModel[23] = new ModelRendererTurbo(this, 224, 222, textureX, textureY, "marker_booster_body_23"); // Box 307 glowey marker booster
		bodyModel[24] = new ModelRendererTurbo(this, 224, 222, textureX, textureY, "marker_booster_body_24"); // Box 308 glowey marker booster
		bodyModel[25] = new ModelRendererTurbo(this, 224, 227, textureX, textureY, "marker_booster_ssw_body_25"); // Box 307 glowey marker booster ssw
		bodyModel[26] = new ModelRendererTurbo(this, 224, 227, textureX, textureY, "marker_booster_ssw_body_26"); // Box 308 glowey marker booster ssw
