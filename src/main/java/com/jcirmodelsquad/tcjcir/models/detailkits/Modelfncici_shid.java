...
public class Modelfncici_shid extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[3] = new ModelRendererTurbo(this, 201, 167, textureX, textureY, "marker_body_3"); // Box 71 markerlight cull
		bodyModel[4] = new ModelRendererTurbo(this, 185, 189, textureX, textureY); // Box 235
		bodyModel[5] = new ModelRendererTurbo(this, 201, 167, textureX, textureY, "marker_body_5"); // Box 124 markerlight cull
		...
		bodyModel[22] = new ModelRendererTurbo(this, 178, 127, textureX, textureY, "numberboard"); // Box 117 Numberboard
		bodyModel[23] = new ModelRendererTurbo(this, 178, 127, textureX, textureY, "numberboard"); // Box 118 Numberboard
		...
		bodyModel[40] = new ModelRendererTurbo(this, 17, 194, textureX, textureY, "cab_speedometer_body_40"); // Box 71 glow speedometer
