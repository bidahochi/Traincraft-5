...
public class Modelclass74_deets extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[3] = new ModelRendererTurbo(this, 40, 12, textureX, textureY, "marker_body_3"); // Box 479 markerlight
		bodyModel[4] = new ModelRendererTurbo(this, 40, 12, textureX, textureY, "marker_body_4"); // Box 480 markerlight
		...
		bodyModel[22] = new ModelRendererTurbo(this, 40, 19, textureX, textureY, "marker_body_22"); // Box 479 markerlight
		bodyModel[23] = new ModelRendererTurbo(this, 40, 19, textureX, textureY, "marker_body_23"); // Box 480 markerlight
