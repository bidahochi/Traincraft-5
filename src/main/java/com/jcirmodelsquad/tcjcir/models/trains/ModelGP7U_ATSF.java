...
public class ModelGP7U_ATSF extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[177] = new ModelRendererTurbo(this, 398, 121, textureX, textureY, "numberboard").setLightFixtureId("rear_numberboard_body_177"); // Box 115 numberboard rear
		bodyModel[178] = new ModelRendererTurbo(this, 398, 121, textureX, textureY, "numberboard").setLightFixtureId("rear_numberboard_body_178"); // Box 116 numberboard rear
		...
		bodyModel[305] = new ModelRendererTurbo(this, 395, 124, textureX, textureY, "marker").setLightFixtureId("marker_body_305"); // Box 559 markerlight
		bodyModel[306] = new ModelRendererTurbo(this, 395, 124, textureX, textureY, "marker").setLightFixtureId("marker_body_306"); // Box 559 markerlight
		...
		bodyModel[310] = new ModelRendererTurbo(this, 493, 75, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_310"); // Box 591 speedoooo
		...
		bodyModel[346] = new ModelRendererTurbo(this, 47, 84, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_346"); // Box 117 Numberboard
		bodyModel[347] = new ModelRendererTurbo(this, 47, 84, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_347"); // Box 118 Numberboard
		...
		bodyModel[399] = new ModelRendererTurbo(this, 94, 119, textureX, textureY, "marker").setLightFixtureId("marker_two_body_399"); // Box 71 markerlight twO
		bodyModel[400] = new ModelRendererTurbo(this, 94, 119, textureX, textureY, "lamp"); // Box 1208 makrerlight twO
		bodyModel[401] = new ModelRendererTurbo(this, 359, 114, textureX, textureY, "marker").setLightFixtureId("marker_two_body_401"); // Box 71 markerlight twO
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (GetColor(entity) == 15) {
			...
			GL11.glPopMatrix();
				...
				||GetColor(entity) == 6 ||GetColor(entity) == 17){
