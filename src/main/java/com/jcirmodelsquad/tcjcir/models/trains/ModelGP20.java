...
public class ModelGP20 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[72] = new ModelRendererTurbo(this, 91, 93, textureX, textureY, "numberboard"); // Box 117 numberboard front high
		bodyModel[73] = new ModelRendererTurbo(this, 91, 93, textureX, textureY, "numberboard"); // Box 118 numberboard front high
		...
		bodyModel[135] = new ModelRendererTurbo(this, 398, 121, textureX, textureY, "numberboard"); // Box 115 numberboard rear
		bodyModel[136] = new ModelRendererTurbo(this, 398, 121, textureX, textureY, "numberboard"); // Box 116 numberboard rear
		...
		bodyModel[144] = new ModelRendererTurbo(this, 73, 84, textureX, textureY, "numberboard"); // Box 363 numberboard chop A
		bodyModel[145] = new ModelRendererTurbo(this, 73, 84, textureX, textureY, "numberboard"); // Box 364 numberboard chop A
		...
		bodyModel[234] = new ModelRendererTurbo(this, 493, 75, textureX, textureY, "cab_speedometer_body_234"); // Box 591 speedoooo
		...
		bodyModel[259] = new ModelRendererTurbo(this, 146, 40, textureX, textureY, "marker_sd9_body_259"); // Box 301 sd9 markerlight
		bodyModel[260] = new ModelRendererTurbo(this, 149, 41, textureX, textureY); // Box 302 marker box
		bodyModel[261] = new ModelRendererTurbo(this, 146, 40, textureX, textureY, "marker_sd9_body_261"); // Box 303 sd9 markerlight
		bodyModel[262] = new ModelRendererTurbo(this, 149, 53, textureX, textureY); // Box chop markers 
		bodyModel[263] = new ModelRendererTurbo(this, 156, 52, textureX, textureY, "marker_box_chop_body_263"); // Box chop markers glow
		bodyModel[264] = new ModelRendererTurbo(this, 141, 53, textureX, textureY); // Box chop markers 
		bodyModel[265] = new ModelRendererTurbo(this, 156, 55, textureX, textureY, "marker_box_chop_body_265"); // Box chop markers glow
		bodyModel[266] = new ModelRendererTurbo(this, 147, 34, textureX, textureY, "marker_box_lownose_body_266"); // Box lownose markers glow
		bodyModel[267] = new ModelRendererTurbo(this, 147, 34, textureX, textureY, "marker_box_lownose_body_267"); // Box lownose markers glow
