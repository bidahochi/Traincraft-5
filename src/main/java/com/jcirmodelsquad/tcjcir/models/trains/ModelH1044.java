...
public class ModelH1044 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[161] = new ModelRendererTurbo(this, 441, 57, textureX, textureY, "rear_commander"); // Box 162 light commander beacon rear
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if(GetColor(entity)==15345 || GetColor(entity)==11){
