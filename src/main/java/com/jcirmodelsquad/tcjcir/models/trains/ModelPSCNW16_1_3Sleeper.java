...
public class ModelPSCNW16_1_3Sleeper extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[491] = new ModelRendererTurbo(this, 151, 348, textureX, textureY,"interior").setLightFixtureId("interior_body_491"); // Box 38 glow
		bodyModel[492] = new ModelRendererTurbo(this, 272, 351, textureX, textureY,"interior").setLightFixtureId("interior_body_492"); // Box 38 glow
		bodyModel[493] = new ModelRendererTurbo(this, 52, 349, textureX, textureY,"interior").setLightFixtureId("interior_body_493"); // Box 38 glow
	...
	private void initbodyModel_2()
	{
		...
		bodyModel[603] = new ModelRendererTurbo(this, 393, 182, textureX, textureY,"interior").setLightFixtureId("interior_body_603"); // Box 462 glow
		bodyModel[604] = new ModelRendererTurbo(this, 393, 180, textureX, textureY,"interior").setLightFixtureId("interior_body_604"); // Box 462 glow
		bodyModel[605] = new ModelRendererTurbo(this, 390, 180, textureX, textureY,"interior").setLightFixtureId("interior_body_605"); // Box 462 glow
		bodyModel[606] = new ModelRendererTurbo(this, 388, 176, textureX, textureY,"interior").setLightFixtureId("interior_body_606"); // Box 462 glow
		bodyModel[607] = new ModelRendererTurbo(this, 391, 176, textureX, textureY,"interior").setLightFixtureId("interior_body_607"); // Box 462 glow
		bodyModel[608] = new ModelRendererTurbo(this, 384, 178, textureX, textureY,"interior").setLightFixtureId("interior_body_608"); // Box 462 glow
		bodyModel[609] = new ModelRendererTurbo(this, 429, 174, textureX, textureY,"interior").setLightFixtureId("interior_body_609"); // Box 462 glow
		bodyModel[610] = new ModelRendererTurbo(this, 383, 174, textureX, textureY,"interior").setLightFixtureId("interior_body_610"); // Box 462 glow
		bodyModel[611] = new ModelRendererTurbo(this, 338, 172, textureX, textureY,"interior").setLightFixtureId("interior_body_611"); // Box 462 glow
		bodyModel[612] = new ModelRendererTurbo(this, 353, 166, textureX, textureY,"interior").setLightFixtureId("interior_body_612"); // Box 462 glow
		bodyModel[613] = new ModelRendererTurbo(this, 353, 168, textureX, textureY); // Box 618
		bodyModel[614] = new ModelRendererTurbo(this, 353, 164, textureX, textureY,"interior").setLightFixtureId("interior_body_614"); // Box 462 glow
