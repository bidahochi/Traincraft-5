...
public class ModelDR441500Phase2 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[457] = new ModelRendererTurbo(this, 11, 154, textureX, textureY, "marker").setLightFixtureId("marker_r_type_1"); // Markerlight R type 1
		bodyModel[458] = new ModelRendererTurbo(this, 9, 150, textureX, textureY); // Box 216
		bodyModel[459] = new ModelRendererTurbo(this, 75, 154, textureX, textureY, "marker").setLightFixtureId("marker_l_type_1"); // Markerlight L type 1
		bodyModel[460] = new ModelRendererTurbo(this, 74, 147, textureX, textureY, "numberboard").setLightFixtureId("numberboard_left_body_460"); // Numberboard L type 1
		bodyModel[461] = new ModelRendererTurbo(this, 10, 147, textureX, textureY, "numberboard").setLightFixtureId("rear_numberboard_right_body_461"); // Numberboard R type 1
		...
		bodyModel[466] = new ModelRendererTurbo(this, 17, 147, textureX, textureY, "numberboard").setLightFixtureId("rear_numberboard_right_body_466"); // Numberboard R type 2
		bodyModel[467] = new ModelRendererTurbo(this, 62, 140, textureX, textureY); // Box 524
		bodyModel[468] = new ModelRendererTurbo(this, 61, 147, textureX, textureY, "numberboard").setLightFixtureId("numberboard_left_body_468"); // Numberboard L Type 2
		...
		bodyModel[483] = new ModelRendererTurbo(this, 21, 154, textureX, textureY, "marker").setLightFixtureId("marker_body_483"); // Box 353 markerlight
		bodyModel[484] = new ModelRendererTurbo(this, 65, 154, textureX, textureY, "marker").setLightFixtureId("marker_body_484"); // Box 545 markerlight
