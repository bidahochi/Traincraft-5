...
public class ModelE8A extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[193] = new ModelRendererTurbo(this, 125, 177, textureX, textureY, "marker_body_193"); // Box 352 markerlight
		bodyModel[194] = new ModelRendererTurbo(this, 51, 177, textureX, textureY, "marker_body_194"); // Box 353 markerlight
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (GetColor(entity) == 6 || GetColor(entity) == 8 || GetColor(entity) == 7) {
