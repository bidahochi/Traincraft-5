...
public class ModelSD39 extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[150] = new ModelRendererTurbo(this, 1, 40, textureX, textureY, "marker").setLightFixtureId("marker_two_body_150"); // Box 71 markerlight twO
		...
		bodyModel[164] = new ModelRendererTurbo(this, 107, 149, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_164"); // Box 71 glow speedometer
		...
		bodyModel[209] = new ModelRendererTurbo(this, 465, 76, textureX, textureY, "numberboard").setLightFixtureId("rear_numberboard_body_209"); // Box 115 numberboard rear
		bodyModel[210] = new ModelRendererTurbo(this, 491, 76, textureX, textureY, "numberboard").setLightFixtureId("rear_numberboard_body_210"); // Box 116 numberboard rear
		...
		bodyModel[219] = new ModelRendererTurbo(this, 454, 89, textureX, textureY, "marker").setLightFixtureId("marker_two_body_219"); // Box 71 markerlight twO
		bodyModel[220] = new ModelRendererTurbo(this, 454, 89, textureX, textureY, "lamp"); // Box 1208 makrerlight twO
		bodyModel[221] = new ModelRendererTurbo(this, 450, 84, textureX, textureY, "marker").setLightFixtureId("marker_two_body_221"); // Box 71 markerlight twO
	...
	private void initbodyModel_2()
	{
		...
		bodyModel[524] = new ModelRendererTurbo(this, 106, 39, textureX, textureY, "marker").setLightFixtureId("marker_nar_body_524"); // Box 117 Glow marker light NAR
		bodyModel[525] = new ModelRendererTurbo(this, 106, 39, textureX, textureY, "marker").setLightFixtureId("marker_nar_body_525"); // Box 117 Glow marker light NAR
		...
		bodyModel[530] = new ModelRendererTurbo(this, 104, 37, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_body_530"); // Box 117 numberboard front
		bodyModel[531] = new ModelRendererTurbo(this, 93, 45, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_body_531"); // Box 118 numberboard front
		bodyModel[532] = new ModelRendererTurbo(this, 32, 83, textureX, textureY, "marker").setLightFixtureId("marker_two_body_532"); // Box 71 markerlight twO
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (GetColor(entity) == 135245) {
			...
			flexMid.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 7||GetColor(entity) == 3
				||GetColor(entity) == 16||GetColor(entity) == 4
				||GetColor(entity) == 20) {
			//black regular truck
			...
			flexMid.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 6 ||GetColor(entity) == 5) {
			//grey regular truck
