...
public class ModelSW10 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[199] = new ModelRendererTurbo(this, 467, 188, textureX, textureY, "cab_speedometer_body_199"); // Box 275 cs2 speedo glow
		...
		bodyModel[255] = new ModelRendererTurbo(this, 430, 180, textureX, textureY, "cab_speedometer_body_255"); // Box 71 cs glow speedometer
		bodyModel[256] = new ModelRendererTurbo(this, 430, 175, textureX, textureY); // Box 307 cs speedo
		bodyModel[257] = new ModelRendererTurbo(this, 275, 150, textureX, textureY, "numberboard"); // Box 168 numberboard front double
		bodyModel[258] = new ModelRendererTurbo(this, 275, 150, textureX, textureY, "numberboard"); // Box 167 numberboard front double
		bodyModel[259] = new ModelRendererTurbo(this, 482, 22, textureX, textureY, "numberboard"); // Box 168 numberboard rear double
		bodyModel[260] = new ModelRendererTurbo(this, 482, 22, textureX, textureY, "numberboard"); // Box 167 numberboard rear double
