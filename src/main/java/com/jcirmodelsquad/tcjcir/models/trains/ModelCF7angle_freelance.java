...
public class ModelCF7angle_freelance extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[39] = new ModelRendererTurbo(this, 403, 196, textureX, textureY, "marker_body_39"); // Box 71 markerlight cull
		bodyModel[40] = new ModelRendererTurbo(this, 430, 193, textureX, textureY); // Box 235
		bodyModel[41] = new ModelRendererTurbo(this, 403, 196, textureX, textureY, "marker_body_41"); // Box 124 markerlight cull
		...
		bodyModel[109] = new ModelRendererTurbo(this, 247, 86, textureX, textureY, "gyra_rear_l"); // Box 334 Rear Gyralight L
		bodyModel[110] = new ModelRendererTurbo(this, 254, 86, textureX, textureY, "gyra_rear_r"); // Box 335 Rear Gyralight R
		...
		bodyModel[113] = new ModelRendererTurbo(this, 251, 92, textureX, textureY, "numberboard"); // Box 117 Numberboard R
		bodyModel[114] = new ModelRendererTurbo(this, 251, 92, textureX, textureY, "numberboard"); // Box 118 Numberboard R
		...
		bodyModel[129] = new ModelRendererTurbo(this, 348, 111, textureX, textureY, "numberboard"); // Box 117 Numberboard
		bodyModel[130] = new ModelRendererTurbo(this, 348, 111, textureX, textureY, "numberboard"); // Box 118 Numberboard
		...
		bodyModel[176] = new ModelRendererTurbo(this, 317, 113, textureX, textureY, "gyra_front_l"); // Box 337 Front Gyralight L
		bodyModel[177] = new ModelRendererTurbo(this, 324, 113, textureX, textureY, "gyra_front_r"); // Box 338 Front Gyralight R
		...
		bodyModel[239] = new ModelRendererTurbo(this, 348, 206, textureX, textureY, "ditch2f1"); // Box 189 ditchlight f up
		bodyModel[240] = new ModelRendererTurbo(this, 348, 206, textureX, textureY, "ditch2f2"); // Box 190 ditchlight f up
		bodyModel[241] = new ModelRendererTurbo(this, 356, 206, textureX, textureY); // Box 239
		bodyModel[242] = new ModelRendererTurbo(this, 363, 206, textureX, textureY, "ditch2r1"); // Box 240 ditchlight r up
		bodyModel[243] = new ModelRendererTurbo(this, 363, 206, textureX, textureY, "ditch2r2"); // Box 241 ditchlight r up
		...
		bodyModel[247] = new ModelRendererTurbo(this, 348, 211, textureX, textureY, "ditch1f1"); // Box 189 ditchlight f up2
		bodyModel[248] = new ModelRendererTurbo(this, 348, 211, textureX, textureY, "ditch1f2"); // Box 190 ditchlight f up2
		bodyModel[249] = new ModelRendererTurbo(this, 356, 211, textureX, textureY); // Box 239
		bodyModel[250] = new ModelRendererTurbo(this, 363, 211, textureX, textureY, "ditch1r1"); // Box 24 ditchlight r up2
		bodyModel[251] = new ModelRendererTurbo(this, 363, 211, textureX, textureY, "ditch1r2"); // Box 241 ditchlight r up2
		bodyModel[252] = new ModelRendererTurbo(this, 356, 211, textureX, textureY); // Box 242
		bodyModel[253] = new ModelRendererTurbo(this, 348, 196, textureX, textureY, "ditch3f2"); // Box 359 ditchlight f down3
		...
		bodyModel[256] = new ModelRendererTurbo(this, 348, 196, textureX, textureY, "ditch3f1"); // Box 362 ditchlight f down3
		bodyModel[257] = new ModelRendererTurbo(this, 341, 201, textureX, textureY); // Box 188 ditch mount
		bodyModel[258] = new ModelRendererTurbo(this, 348, 201, textureX, textureY, "ditch4f1"); // Box 190 ditchlight f down2 AR
		bodyModel[259] = new ModelRendererTurbo(this, 348, 201, textureX, textureY, "ditch4f2"); // Box 371 ditchlight f down2 AR
		...
		bodyModel[262] = new ModelRendererTurbo(this, 348, 191, textureX, textureY, "ditch5f1"); // Box 399 ditchlight f down
		bodyModel[263] = new ModelRendererTurbo(this, 348, 191, textureX, textureY, "ditch5f2"); // Box 400 ditchlight f down
		bodyModel[264] = new ModelRendererTurbo(this, 341, 191, textureX, textureY); // Box 401 ditch mount
		bodyModel[265] = new ModelRendererTurbo(this, 363, 191, textureX, textureY, "ditch5r1"); // Box 394 ditchlight r down
		bodyModel[266] = new ModelRendererTurbo(this, 356, 191, textureX, textureY); // Box 395 ditch mount
		bodyModel[267] = new ModelRendererTurbo(this, 363, 191, textureX, textureY, "ditch5r2"); // Box 396 ditchlight r down
		...
		bodyModel[270] = new ModelRendererTurbo(this, 363, 201, textureX, textureY, "ditch4r2"); // Box 190 ditchlight r down2
		bodyModel[271] = new ModelRendererTurbo(this, 363, 201, textureX, textureY, "ditch4r1"); // Box 371 ditchlight r down2
		...
		bodyModel[455] = new ModelRendererTurbo(this, 261, 88, textureX, textureY, "marker_brw_42_body_455"); // Box 322 brw 42 markerlight
		bodyModel[456] = new ModelRendererTurbo(this, 261, 88, textureX, textureY, "marker_brw_42_body_456"); // Box 324 brw 42 markerlight
		...
		bodyModel[459] = new ModelRendererTurbo(this, 462, 108, textureX, textureY, "cab_speedometer_body_459"); // Box 591 speedo glow
		bodyModel[460] = new ModelRendererTurbo(this, 356, 196, textureX, textureY, "cull"); // Box 516 ditchlight cull fcen 50
		bodyModel[461] = new ModelRendererTurbo(this, 363, 196, textureX, textureY, "ditch3r1"); // Box 517 ditchlight rear down 3
		bodyModel[462] = new ModelRendererTurbo(this, 363, 196, textureX, textureY, "ditch3r2"); // Box 518 ditchlight rear down 3
