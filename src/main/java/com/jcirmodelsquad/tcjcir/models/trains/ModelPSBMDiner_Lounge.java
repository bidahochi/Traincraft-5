...
public class ModelPSBMDiner_Lounge extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[336] = new ModelRendererTurbo(this, 279, 260, textureX, textureY,"interior").setLightFixtureId("interior_body_336"); // Box 128 glow
		bodyModel[337] = new ModelRendererTurbo(this, 279, 256, textureX, textureY,"interior").setLightFixtureId("interior_body_337"); // Box 128 glow
		...
		bodyModel[348] = new ModelRendererTurbo(this, 75, 372, textureX, textureY,"interior").setLightFixtureId("interior_body_348"); // Box 38 glow
		...
		bodyModel[367] = new ModelRendererTurbo(this, 185, 369, textureX, textureY,"interior").setLightFixtureId("interior_body_367"); // Box 38 glow
		bodyModel[368] = new ModelRendererTurbo(this, 172, 371, textureX, textureY,"interior").setLightFixtureId("interior_body_368"); // Box 38 glow
		bodyModel[369] = new ModelRendererTurbo(this, 169, 366, textureX, textureY,"interior").setLightFixtureId("interior_body_369"); // Box 38 glow
		bodyModel[370] = new ModelRendererTurbo(this, 169, 385, textureX, textureY,"interior").setLightFixtureId("interior_body_370"); // Box 38 glow
		bodyModel[371] = new ModelRendererTurbo(this, 198, 369, textureX, textureY,"interior").setLightFixtureId("interior_body_371"); // Box 38 glow
		bodyModel[372] = new ModelRendererTurbo(this, 212, 366, textureX, textureY,"interior").setLightFixtureId("interior_body_372"); // Box 38 glow
		bodyModel[373] = new ModelRendererTurbo(this, 198, 374, textureX, textureY,"interior").setLightFixtureId("interior_body_373"); // Box 462 glow
		bodyModel[374] = new ModelRendererTurbo(this, 212, 385, textureX, textureY,"interior").setLightFixtureId("interior_body_374"); // Box 463 glow
		bodyModel[375] = new ModelRendererTurbo(this, 173, 370, textureX, textureY,"interior").setLightFixtureId("interior_body_375"); // Box 38 glow
		bodyModel[376] = new ModelRendererTurbo(this, 164, 366, textureX, textureY,"interior").setLightFixtureId("interior_body_376"); // Box 38 glow
		bodyModel[377] = new ModelRendererTurbo(this, 173, 375, textureX, textureY,"interior").setLightFixtureId("interior_body_377"); // Box 462 glow
		bodyModel[378] = new ModelRendererTurbo(this, 164, 385, textureX, textureY,"interior").setLightFixtureId("interior_body_378"); // Box 463 glow
		bodyModel[379] = new ModelRendererTurbo(this, 210, 372, textureX, textureY,"interior").setLightFixtureId("interior_body_379"); // Box 38 glow
		bodyModel[380] = new ModelRendererTurbo(this, 149, 372, textureX, textureY,"interior").setLightFixtureId("interior_body_380"); // Box 38 glow
		bodyModel[381] = new ModelRendererTurbo(this, 166, 358, textureX, textureY,"interior").setLightFixtureId("interior_body_381"); // Box 38 glow
		bodyModel[382] = new ModelRendererTurbo(this, 165, 394, textureX, textureY,"interior").setLightFixtureId("interior_body_382"); // Box 38 glow
		bodyModel[383] = new ModelRendererTurbo(this, 217, 366, textureX, textureY,"interior").setLightFixtureId("interior_body_383"); // Box 38 glow
		bodyModel[384] = new ModelRendererTurbo(this, 207, 358, textureX, textureY,"interior").setLightFixtureId("interior_body_384"); // Box 38 glow
		bodyModel[385] = new ModelRendererTurbo(this, 217, 385, textureX, textureY,"interior").setLightFixtureId("interior_body_385"); // Box 462 glow
		bodyModel[386] = new ModelRendererTurbo(this, 206, 394, textureX, textureY,"interior").setLightFixtureId("interior_body_386"); // Box 463 glow
		bodyModel[387] = new ModelRendererTurbo(this, 156, 366, textureX, textureY,"interior").setLightFixtureId("interior_body_387"); // Box 38 glow
		bodyModel[388] = new ModelRendererTurbo(this, 163, 358, textureX, textureY,"interior").setLightFixtureId("interior_body_388"); // Box 38 glow
		bodyModel[389] = new ModelRendererTurbo(this, 156, 385, textureX, textureY,"interior").setLightFixtureId("interior_body_389"); // Box 462 glow
		bodyModel[390] = new ModelRendererTurbo(this, 162, 394, textureX, textureY,"interior").setLightFixtureId("interior_body_390"); // Box 463 glow
	...
	private void initbodyModel_2()
	{
		...
		bodyModel[505] = new ModelRendererTurbo(this, 242, 303, textureX, textureY,"interior").setLightFixtureId("interior_body_505"); // Box 128 glow
		...
		bodyModel[528] = new ModelRendererTurbo(this, 178, 322, textureX, textureY,"interior").setLightFixtureId("interior_body_528"); // Box 128 glow
		bodyModel[529] = new ModelRendererTurbo(this, 59, 334, textureX, textureY,"interior").setLightFixtureId("interior_body_529"); // Box 128 glow
		bodyModel[530] = new ModelRendererTurbo(this, 52, 334, textureX, textureY,"interior").setLightFixtureId("interior_body_530"); // Box 128 glow
		bodyModel[531] = new ModelRendererTurbo(this, 45, 334, textureX, textureY,"interior").setLightFixtureId("interior_body_531"); // Box 128 glow
