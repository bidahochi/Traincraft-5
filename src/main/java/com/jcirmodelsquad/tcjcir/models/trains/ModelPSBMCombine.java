...
public class ModelPSBMCombine extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[156] = new ModelRendererTurbo(this, 107, 331, textureX, textureY,"interior").setLightFixtureId("interior_body_156"); // Box 38 glow
		...
		bodyModel[166] = new ModelRendererTurbo(this, 98, 331, textureX, textureY,"interior").setLightFixtureId("interior_body_166"); // Box 38 glow
		...
		bodyModel[202] = new ModelRendererTurbo(this, 43, 292, textureX, textureY,"interior").setLightFixtureId("interior_body_202"); // Box 38 glow
		bodyModel[203] = new ModelRendererTurbo(this, 34, 292, textureX, textureY,"interior").setLightFixtureId("interior_body_203"); // Box 38 glow
		bodyModel[204] = new ModelRendererTurbo(this, 61, 292, textureX, textureY,"interior").setLightFixtureId("interior_body_204"); // Box 38 glow
		bodyModel[205] = new ModelRendererTurbo(this, 52, 292, textureX, textureY,"interior").setLightFixtureId("interior_body_205"); // Box 38 glow
		bodyModel[206] = new ModelRendererTurbo(this, 70, 292, textureX, textureY,"interior").setLightFixtureId("interior_body_206"); // Box 38 glow
		...
		bodyModel[391] = new ModelRendererTurbo(this, 118, 242, textureX, textureY,"interior").setLightFixtureId("interior_body_391"); // Box 38 glow
		bodyModel[392] = new ModelRendererTurbo(this, 118, 246, textureX, textureY,"interior").setLightFixtureId("interior_body_392"); // Box 38 glow
		...
		bodyModel[433] = new ModelRendererTurbo(this, 98, 323, textureX, textureY,"interior").setLightFixtureId("interior_body_433"); // Box 38 glow
		bodyModel[434] = new ModelRendererTurbo(this, 98, 326, textureX, textureY,"interior").setLightFixtureId("interior_body_434"); // Box 38 glow
		bodyModel[435] = new ModelRendererTurbo(this, 167, 287, textureX, textureY); // Box 128
		bodyModel[436] = new ModelRendererTurbo(this, 202, 331, textureX, textureY,"interior").setLightFixtureId("interior_body_436"); // Box 38 glow
		bodyModel[437] = new ModelRendererTurbo(this, 78, 299, textureX, textureY,"interior").setLightFixtureId("interior_body_437"); // Box 38 glow
		bodyModel[438] = new ModelRendererTurbo(this, 30, 280, textureX, textureY,"interior").setLightFixtureId("interior_body_438"); // Box 38 glow
