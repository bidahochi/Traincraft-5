...
public class ModelHBC1B extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[106] = new ModelRendererTurbo(this, 248, 201, textureX, textureY, "lamp").setLightFixtureId("rear_left"); // Box 289 rear light L
		bodyModel[107] = new ModelRendererTurbo(this, 248, 206, textureX, textureY, "lamp").setLightFixtureId("rear_right"); // Box 290 rear light R
		bodyModel[108] = new ModelRendererTurbo(this, 257, 194, textureX, textureY); // Box 410
		bodyModel[109] = new ModelRendererTurbo(this, 259, 206, textureX, textureY, "lamp").setLightFixtureId("front_right"); // Box 411 front light R
		bodyModel[110] = new ModelRendererTurbo(this, 259, 201, textureX, textureY, "lamp").setLightFixtureId("front_left"); // Box 412 front light L
		bodyModel[111] = new ModelRendererTurbo(this, 251, 216, textureX, textureY, BoxName.prime1.prime1).setLightFixtureId("prime_1"); // Box 6 PRIME1-1
		bodyModel[112] = new ModelRendererTurbo(this, 251, 216, textureX, textureY, BoxName.prime1.prime3).setLightFixtureId("prime_3"); // Box 7 PRIME1-3
		bodyModel[113] = new ModelRendererTurbo(this, 251, 216, textureX, textureY, BoxName.prime1.prime2).setLightFixtureId("prime_2"); // Box 8 PRIME1-2
		bodyModel[114] = new ModelRendererTurbo(this, 251, 216, textureX, textureY, BoxName.prime1.prime4).setLightFixtureId("prime_4"); // Box 9 PRIME1-4
