...
public class ModelH24_66 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[263] = new ModelRendererTurbo(this, 51, 42, textureX, textureY, BoxName.marker).setLightFixtureId("marker_fl_body_263"); // marker light FL
		bodyModel[264] = new ModelRendererTurbo(this, 15, 42, textureX, textureY, BoxName.marker).setLightFixtureId("marker_fr_body_264"); // marker light FR
		bodyModel[265] = new ModelRendererTurbo(this, 341, 303, textureX, textureY, BoxName.marker).setLightFixtureId("marker_rl_body_265"); // marker light RL
		bodyModel[266] = new ModelRendererTurbo(this, 405, 303, textureX, textureY, BoxName.marker).setLightFixtureId("marker_rr_body_266"); // marker light RR
		...
		bodyModel[423] = new ModelRendererTurbo(this, 53, 39, textureX, textureY, BoxName.marker).setLightFixtureId("marker_fl_body_423"); // marker light FL
		bodyModel[424] = new ModelRendererTurbo(this, 12, 39, textureX, textureY, BoxName.marker).setLightFixtureId("marker_fr_body_424"); // marker light FR
		bodyModel[425] = new ModelRendererTurbo(this, 341, 300, textureX, textureY, BoxName.marker).setLightFixtureId("marker_rl_body_425"); // marker light RL
		bodyModel[426] = new ModelRendererTurbo(this, 405, 300, textureX, textureY, BoxName.marker).setLightFixtureId("marker_rr_body_426"); // marker light RR
