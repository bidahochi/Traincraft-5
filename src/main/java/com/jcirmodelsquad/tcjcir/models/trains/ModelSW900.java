...
public class ModelSW900 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[144] = new ModelRendererTurbo(this, 293, 121, textureX, textureY, "numberboard"); // Box 625 sp numerbboard
		bodyModel[145] = new ModelRendererTurbo(this, 293, 121, textureX, textureY, "numberboard"); // Box 626 sp numberboard
		...
		bodyModel[324] = new ModelRendererTurbo(this, 438, 138, textureX, textureY, "cab_speedometer_body_324"); // Box 275 cs2 speedo glow
		...
		bodyModel[401] = new ModelRendererTurbo(this, 430, 180, textureX, textureY, "cab_speedometer_body_401"); // Box 71 cs glow speedometer
		bodyModel[402] = new ModelRendererTurbo(this, 430, 175, textureX, textureY); // Box 307 cs speedo
		bodyModel[403] = new ModelRendererTurbo(this, 275, 150, textureX, textureY, "numberboard"); // Box 168 numberboard front double
		bodyModel[404] = new ModelRendererTurbo(this, 275, 150, textureX, textureY, "numberboard"); // Box 167 numberboard front double
		bodyModel[405] = new ModelRendererTurbo(this, 483, 1, textureX, textureY, "numberboard"); // Box 167 numberboard rear single
		bodyModel[406] = new ModelRendererTurbo(this, 483, 1, textureX, textureY, "numberboard"); // Box 168 numberboard rear single
		bodyModel[407] = new ModelRendererTurbo(this, 482, 22, textureX, textureY, "numberboard"); // Box 168 numberboard rear double
		bodyModel[408] = new ModelRendererTurbo(this, 482, 22, textureX, textureY, "numberboard"); // Box 167 numberboard rear double
		...
		bodyModel[417] = new ModelRendererTurbo(this, 245, 53, textureX, textureY, "numberboard"); // Box 416 more sp numberboard
		...
		bodyModel[421] = new ModelRendererTurbo(this, 245, 49, textureX, textureY, "numberboard"); // Box 420 more sp numberboard
		bodyModel[422] = new ModelRendererTurbo(this, 275, 134, textureX, textureY, "marker_crl_body_422"); // Box 422 crl markerlight
		bodyModel[423] = new ModelRendererTurbo(this, 275, 134, textureX, textureY, "marker_crl_body_423"); // Box 422 crl markerlight
		bodyModel[424] = new ModelRendererTurbo(this, 275, 134, textureX, textureY, "marker_crl_body_424"); // Box 422 crl markerlight
		bodyModel[425] = new ModelRendererTurbo(this, 275, 134, textureX, textureY, "marker_crl_body_425"); // Box 422 crl markerlight
