...
public class ModelFP45 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[57] = new ModelRendererTurbo(this, 321, 33, textureX, textureY, "numberboard"); // Box 117 liveryimg 2 glow
		bodyModel[58] = new ModelRendererTurbo(this, 441, 33, textureX, textureY, "numberboard"); // Box 118 liveryimg 2 glow
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		} else if (GetColor(entity) == 4 || GetColor(entity) == 7 || GetColor(entity) == 8) {
