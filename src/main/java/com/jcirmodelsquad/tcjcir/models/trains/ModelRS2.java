...
public class ModelRS2 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[150] = new ModelRendererTurbo(this, 148, 60, textureX, textureY, "marker").setLightFixtureId("marker_2_body_150"); // Markerlight 2
		bodyModel[151] = new ModelRendererTurbo(this, 149, 65, textureX, textureY); // Box 2
		bodyModel[152] = new ModelRendererTurbo(this, 148, 60, textureX, textureY, "marker").setLightFixtureId("marker_2_body_152"); // Markerlight 2
		...
		bodyModel[250] = new ModelRendererTurbo(this, 148, 78, textureX, textureY, "marker").setLightFixtureId("marker_body_250"); // Markerlight
		bodyModel[251] = new ModelRendererTurbo(this, 148, 78, textureX, textureY, "marker").setLightFixtureId("marker_body_251"); // Markerlight
		...
		bodyModel[373] = new ModelRendererTurbo(this, 157, 62, textureX, textureY, "marker").setLightFixtureId("marker_2_body_373"); // Markerlight 2 glow
		bodyModel[374] = new ModelRendererTurbo(this, 157, 65, textureX, textureY, "marker").setLightFixtureId("marker_2_body_374"); // Markerlight 2 glow
		bodyModel[375] = new ModelRendererTurbo(this, 157, 62, textureX, textureY, "marker").setLightFixtureId("marker_2_body_375"); // Markerlight 2 glow
		bodyModel[376] = new ModelRendererTurbo(this, 157, 65, textureX, textureY, "marker").setLightFixtureId("marker_2_body_376"); // Markerlight 2 glow
		bodyModel[377] = new ModelRendererTurbo(this, 148, 69, textureX, textureY, "marker").setLightFixtureId("marker_1_body_377"); // Markerlight 1
		bodyModel[378] = new ModelRendererTurbo(this, 157, 71, textureX, textureY, "marker").setLightFixtureId("marker_2_body_378"); // Markerlight 2 glow
		bodyModel[379] = new ModelRendererTurbo(this, 157, 74, textureX, textureY, "marker").setLightFixtureId("marker_2_body_379"); // Markerlight 2 glow
		bodyModel[380] = new ModelRendererTurbo(this, 148, 69, textureX, textureY, "marker").setLightFixtureId("marker_1_body_380"); // Markerlight 1
		bodyModel[381] = new ModelRendererTurbo(this, 157, 71, textureX, textureY, "marker").setLightFixtureId("marker_2_body_381"); // Markerlight 2 glow
		bodyModel[382] = new ModelRendererTurbo(this, 157, 74, textureX, textureY, "marker").setLightFixtureId("marker_2_body_382"); // Markerlight 2 glow
		bodyModel[383] = new ModelRendererTurbo(this, 204, 40, textureX, textureY, "cull"); // Bell frame cul
		bodyModel[384] = new ModelRendererTurbo(this, 157, 80, textureX, textureY, "marker").setLightFixtureId("marker_body_384"); // Markerlight glow
		bodyModel[385] = new ModelRendererTurbo(this, 157, 83, textureX, textureY, "marker").setLightFixtureId("marker_body_385"); // Markerlight glow
		bodyModel[386] = new ModelRendererTurbo(this, 157, 80, textureX, textureY, "marker").setLightFixtureId("marker_body_386"); // Markerlight glow
		bodyModel[387] = new ModelRendererTurbo(this, 157, 83, textureX, textureY, "marker").setLightFixtureId("marker_body_387"); // Markerlight glow
		...
		bodyModel[397] = new ModelRendererTurbo(this, 50, 46, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_397"); // Wacky numberboard glow
		bodyModel[398] = new ModelRendererTurbo(this, 50, 46, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_398"); // Wacky numberboard glow
		bodyModel[399] = new ModelRendererTurbo(this, 50, 46, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_399"); // Wacky numberboard glow
		bodyModel[400] = new ModelRendererTurbo(this, 50, 46, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_400"); // Wacky numberboard glow
