...
public class Model4ED172T extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[130] = new ModelRendererTurbo(this, 51, 9, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_130"); // Box 117 numberboard
		bodyModel[131] = new ModelRendererTurbo(this, 51, 9, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_131"); // Box 118 numberboard
		...
		bodyModel[160] = new ModelRendererTurbo(this, 220, 48, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_160"); // Box 117 numberboard
		bodyModel[161] = new ModelRendererTurbo(this, 220, 48, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_161"); // Box 118 numberboard
		...
		bodyModel[177] = new ModelRendererTurbo(this, 434, 21, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_177"); // Box 117 numberboard
		bodyModel[178] = new ModelRendererTurbo(this, 434, 21, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_178"); // Box 118 numberboard
		...
		bodyModel[208] = new ModelRendererTurbo(this, 228, 49, textureX, textureY, "marker").setLightFixtureId("marker_body_208"); // Box 266 markerlight
		bodyModel[209] = new ModelRendererTurbo(this, 228, 49, textureX, textureY, "marker").setLightFixtureId("marker_body_209"); // Box 267 markerlight
		bodyModel[210] = new ModelRendererTurbo(this, 442, 22, textureX, textureY, "marker").setLightFixtureId("marker_body_210"); // Box 266 markerlight
		bodyModel[211] = new ModelRendererTurbo(this, 442, 22, textureX, textureY, "marker").setLightFixtureId("marker_body_211"); // Box 267 markerlight
		bodyModel[212] = new ModelRendererTurbo(this, 178, 115, textureX, textureY); // Box 270 sandcap short
		bodyModel[213] = new ModelRendererTurbo(this, 55, 5, textureX, textureY, "marker").setLightFixtureId("marker_body_213"); // Box 266 markerlight
		bodyModel[214] = new ModelRendererTurbo(this, 55, 5, textureX, textureY, "marker").setLightFixtureId("marker_body_214"); // Box 267 markerlight
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (GetColor(entity) == 334) {
			...
			theB.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 439||GetColor(entity) == 326){
			...
			theB.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 18||GetColor(entity) == 19||GetColor(entity) == 20){
		...
		} else if (GetColor(entity) == 6 || GetColor(entity) == 9){
