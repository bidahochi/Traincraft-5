...
public class ModelWPShops600Series extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[219] = new ModelRendererTurbo(this, 137, 1, textureX, textureY, "front_gyralite"); // Box 401 gyra glow
		...
		bodyModel[222] = new ModelRendererTurbo(this, 137, 1, textureX, textureY, "rear_gyralite"); // Box 222 gyra glow
		...
		bodyModel[231] = new ModelRendererTurbo(this, 159, 51, textureX, textureY, "front_right_marker").setLightSourceFaces(LightSourceFaceDirection.NEGATIVE_X, LightSourceFaceDirection.POSITIVE_X, LightSourceFaceDirection.NEGATIVE_Z); // Box 410 glow marker
		bodyModel[232] = new ModelRendererTurbo(this, 164, 51, textureX, textureY); // Box 170
		bodyModel[233] = new ModelRendererTurbo(this, 159, 51, textureX, textureY, "front_left_marker").setLightSourceFaces(LightSourceFaceDirection.NEGATIVE_X, LightSourceFaceDirection.POSITIVE_X, LightSourceFaceDirection.POSITIVE_Z); // Box 410 glow marker
		bodyModel[234] = new ModelRendererTurbo(this, 164, 51, textureX, textureY); // Box 172
		bodyModel[235] = new ModelRendererTurbo(this, 159, 51, textureX, textureY, "rear_right_marker").setLightSourceFaces(LightSourceFaceDirection.POSITIVE_X, LightSourceFaceDirection.NEGATIVE_X, LightSourceFaceDirection.POSITIVE_Z); // Box 410 glow marker
		bodyModel[236] = new ModelRendererTurbo(this, 164, 51, textureX, textureY); // Box 174
		bodyModel[237] = new ModelRendererTurbo(this, 159, 51, textureX, textureY, "rear_left_marker").setLightSourceFaces(LightSourceFaceDirection.POSITIVE_X, LightSourceFaceDirection.NEGATIVE_X, LightSourceFaceDirection.NEGATIVE_Z); // Box 410 glow marker
