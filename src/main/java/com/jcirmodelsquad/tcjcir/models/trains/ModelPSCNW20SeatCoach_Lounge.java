...
public class ModelPSCNW20SeatCoach_Lounge extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[279] = new ModelRendererTurbo(this, 177, 244, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[280] = new ModelRendererTurbo(this, 177, 255, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[281] = new ModelRendererTurbo(this, 284, 247, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[282] = new ModelRendererTurbo(this, 277, 247, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[283] = new ModelRendererTurbo(this, 270, 247, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[284] = new ModelRendererTurbo(this, 263, 247, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[285] = new ModelRendererTurbo(this, 256, 247, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[286] = new ModelRendererTurbo(this, 249, 247, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[287] = new ModelRendererTurbo(this, 242, 247, textureX, textureY, "interior"); // Box 38 glow
		...
		bodyModel[310] = new ModelRendererTurbo(this, 441, 286, textureX, textureY, "interior"); // Box 384 glow
		bodyModel[311] = new ModelRendererTurbo(this, 6, 268, textureX, textureY, "interior"); // Box 384 glow
		bodyModel[312] = new ModelRendererTurbo(this, 3, 268, textureX, textureY, "interior"); // Box 384 glow
		bodyModel[313] = new ModelRendererTurbo(this, 0, 268, textureX, textureY, "interior"); // Box 384 glow
		bodyModel[314] = new ModelRendererTurbo(this, 28, 291, textureX, textureY, "interior"); // Box 384 glow
	...
	private void initbodyModel_2()
	{
		...
		bodyModel[577] = new ModelRendererTurbo(this, 240, 358, textureX, textureY, "interior"); // Box 492 Glow
		bodyModel[578] = new ModelRendererTurbo(this, 244, 334, textureX, textureY); // Box 739
		bodyModel[579] = new ModelRendererTurbo(this, 244, 337, textureX, textureY, "interior"); // Box 740 glow
		...
		bodyModel[582] = new ModelRendererTurbo(this, 363, 363, textureX, textureY, "interior"); // Box 492 Glow
		bodyModel[583] = new ModelRendererTurbo(this, 371, 334, textureX, textureY); // Box 739
		bodyModel[584] = new ModelRendererTurbo(this, 371, 337, textureX, textureY, "interior"); // Box 740 glow
		bodyModel[585] = new ModelRendererTurbo(this, 489, 360, textureX, textureY); // Box 492
		bodyModel[586] = new ModelRendererTurbo(this, 489, 363, textureX, textureY, "interior"); // Box 492 Glow
		bodyModel[587] = new ModelRendererTurbo(this, 489, 341, textureX, textureY); // Box 739
		bodyModel[588] = new ModelRendererTurbo(this, 489, 344, textureX, textureY, "interior"); // Box 740 glow
