...
public class ModelFourCorTrailerComposite extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[282] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_282"); // Ceiling Lamp
		bodyModel[283] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_283"); // Ceiling Lamp
		bodyModel[284] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_284"); // Ceiling Lamp
		bodyModel[285] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_285"); // Ceiling Lamp
		bodyModel[286] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_286"); // Ceiling Lamp
		bodyModel[287] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_287"); // Ceiling Lamp
		bodyModel[288] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_288"); // Ceiling Lamp
