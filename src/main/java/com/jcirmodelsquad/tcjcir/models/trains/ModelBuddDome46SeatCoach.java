...
public class ModelBuddDome46SeatCoach extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[368] = new ModelRendererTurbo(this, 1, 372, textureX, textureY,"interior").setLightFixtureId("interior_body_368"); // Box 38 glow
		bodyModel[369] = new ModelRendererTurbo(this, 3, 401, textureX, textureY,"interior").setLightFixtureId("interior_body_369"); // Box 38 glow
		bodyModel[370] = new ModelRendererTurbo(this, 94, 297, textureX, textureY,"interior").setLightFixtureId("interior_body_370"); // Box 38 glow
		bodyModel[371] = new ModelRendererTurbo(this, 91, 335, textureX, textureY,"interior").setLightFixtureId("interior_body_371"); // Box 38 glow
		...
		bodyModel[374] = new ModelRendererTurbo(this, 150, 268, textureX, textureY,"interior").setLightFixtureId("interior_body_374"); // Box 128 glow
		bodyModel[375] = new ModelRendererTurbo(this, 85, 263, textureX, textureY,"interior").setLightFixtureId("interior_body_375"); // Box 128 glow
		bodyModel[376] = new ModelRendererTurbo(this, 36, 343, textureX, textureY,"interior").setLightFixtureId("interior_body_376"); // Box 128 glow
		bodyModel[377] = new ModelRendererTurbo(this, 45, 351, textureX, textureY,"interior").setLightFixtureId("interior_body_377"); // Box 38 glow
		bodyModel[378] = new ModelRendererTurbo(this, 23, 351, textureX, textureY,"interior").setLightFixtureId("interior_body_378"); // Box 38 glow
		bodyModel[379] = new ModelRendererTurbo(this, 1, 351, textureX, textureY,"interior").setLightFixtureId("interior_body_379"); // Box 38 glow
		bodyModel[380] = new ModelRendererTurbo(this, 49, 348, textureX, textureY,"interior").setLightFixtureId("interior_body_380"); // Box 38 glow
		bodyModel[381] = new ModelRendererTurbo(this, 150, 277, textureX, textureY,"interior").setLightFixtureId("interior_body_381"); // Box 38 glow
		bodyModel[382] = new ModelRendererTurbo(this, 128, 277, textureX, textureY,"interior").setLightFixtureId("interior_body_382"); // Box 38 glow
		bodyModel[383] = new ModelRendererTurbo(this, 139, 277, textureX, textureY,"interior").setLightFixtureId("interior_body_383"); // Box 38 glow
		bodyModel[384] = new ModelRendererTurbo(this, 172, 227, textureX, textureY,"interior").setLightFixtureId("interior_body_384"); // Box 38 glow
		bodyModel[385] = new ModelRendererTurbo(this, 172, 236, textureX, textureY,"interior").setLightFixtureId("interior_body_385"); // Box 950 glow
		...
		bodyModel[391] = new ModelRendererTurbo(this, 108, 347, textureX, textureY,"interior").setLightFixtureId("interior_body_391"); // Box 275 glow
		bodyModel[392] = new ModelRendererTurbo(this, 118, 309, textureX, textureY,"interior").setLightFixtureId("interior_body_392"); // Box 909 glow
		...
		bodyModel[395] = new ModelRendererTurbo(this, 17, 413, textureX, textureY,"interior").setLightFixtureId("interior_body_395"); // Box 275 glow
		bodyModel[396] = new ModelRendererTurbo(this, 9, 384, textureX, textureY,"interior").setLightFixtureId("interior_body_396"); // Box 909 glow
	...
	private void initbodyModel_2()
	{
		...
		bodyModel[626] = new ModelRendererTurbo(this, 161, 275, textureX, textureY,"interior").setLightFixtureId("interior_body_626"); // Box 38 glow
		bodyModel[627] = new ModelRendererTurbo(this, 34, 351, textureX, textureY,"interior").setLightFixtureId("interior_body_627"); // Box 38 glow
		bodyModel[628] = new ModelRendererTurbo(this, 12, 351, textureX, textureY,"interior").setLightFixtureId("interior_body_628"); // Box 38 glow
		...
		bodyModel[639] = new ModelRendererTurbo(this, 161, 272, textureX, textureY,"interior").setLightFixtureId("interior_body_639"); // Box 38 glow
