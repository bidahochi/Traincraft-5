...
public class ModelPS54SeatCoach_Lounge_1950 extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[205] = new ModelRendererTurbo(this, 153, 234, textureX, textureY,"interior").setLightFixtureId("interior_body_205"); // Box 38 glow
		bodyModel[206] = new ModelRendererTurbo(this, 160, 234, textureX, textureY,"interior").setLightFixtureId("interior_body_206"); // Box 38 glow
		bodyModel[207] = new ModelRendererTurbo(this, 167, 234, textureX, textureY,"interior").setLightFixtureId("interior_body_207"); // Box 38 glow
		bodyModel[208] = new ModelRendererTurbo(this, 174, 234, textureX, textureY,"interior").setLightFixtureId("interior_body_208"); // Box 38 glow
		bodyModel[209] = new ModelRendererTurbo(this, 181, 234, textureX, textureY,"interior").setLightFixtureId("interior_body_209"); // Box 38 glow
		bodyModel[210] = new ModelRendererTurbo(this, 188, 234, textureX, textureY,"interior").setLightFixtureId("interior_body_210"); // Box 38 glow
		bodyModel[211] = new ModelRendererTurbo(this, 195, 234, textureX, textureY,"interior").setLightFixtureId("interior_body_211"); // Box 38 glow
		...
		bodyModel[326] = new ModelRendererTurbo(this, 10, 230, textureX, textureY,"interior").setLightFixtureId("interior_body_326"); // Box 38 glow
		bodyModel[327] = new ModelRendererTurbo(this, 11, 234, textureX, textureY,"interior").setLightFixtureId("interior_body_327"); // Box 38 glow
		bodyModel[328] = new ModelRendererTurbo(this, 11, 238, textureX, textureY,"interior").setLightFixtureId("interior_body_328"); // Box 38 glow
		bodyModel[329] = new ModelRendererTurbo(this, 18, 240, textureX, textureY,"interior").setLightFixtureId("interior_body_329"); // Box 38 glow
		bodyModel[330] = new ModelRendererTurbo(this, 25, 238, textureX, textureY,"interior").setLightFixtureId("interior_body_330"); // Box 38 glow
		bodyModel[331] = new ModelRendererTurbo(this, 24, 226, textureX, textureY,"interior").setLightFixtureId("interior_body_331"); // Box 38 glow
		bodyModel[332] = new ModelRendererTurbo(this, 25, 234, textureX, textureY,"interior").setLightFixtureId("interior_body_332"); // Box 38 glow
		bodyModel[333] = new ModelRendererTurbo(this, 10, 226, textureX, textureY,"interior").setLightFixtureId("interior_body_333"); // Box 38 glow
		bodyModel[334] = new ModelRendererTurbo(this, 17, 224, textureX, textureY,"interior").setLightFixtureId("interior_body_334"); // Box 38 glow
		bodyModel[335] = new ModelRendererTurbo(this, 24, 230, textureX, textureY,"interior").setLightFixtureId("interior_body_335"); // Box 38 glow
		...
		bodyModel[412] = new ModelRendererTurbo(this, 331, 241, textureX, textureY,"interior").setLightFixtureId("interior_body_412"); // Box 38 glow
		bodyModel[413] = new ModelRendererTurbo(this, 317, 241, textureX, textureY,"interior").setLightFixtureId("interior_body_413"); // Box 38 glow
		...
		bodyModel[471] = new ModelRendererTurbo(this, 106, 256, textureX, textureY,"interior").setLightFixtureId("interior_body_471"); // Box 275 glow
		bodyModel[472] = new ModelRendererTurbo(this, 106, 199, textureX, textureY,"interior").setLightFixtureId("interior_body_472"); // Box 285 glow
