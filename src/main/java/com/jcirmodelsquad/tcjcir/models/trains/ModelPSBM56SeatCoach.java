...
public class ModelPSBM56SeatCoach extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[101] = new ModelRendererTurbo(this, 107, 331, textureX, textureY,"interior").setLightFixtureId("interior_body_101"); // Box 38 glow
		...
		bodyModel[153] = new ModelRendererTurbo(this, 26, 291, textureX, textureY,"interior").setLightFixtureId("interior_body_153"); // Box 38 glow
		bodyModel[154] = new ModelRendererTurbo(this, 1, 291, textureX, textureY,"interior").setLightFixtureId("interior_body_154"); // Box 38 glow
		bodyModel[155] = new ModelRendererTurbo(this, 20, 293, textureX, textureY,"interior").setLightFixtureId("interior_body_155"); // Box 38 glow
		bodyModel[156] = new ModelRendererTurbo(this, 48, 214, textureX, textureY,"interior").setLightFixtureId("interior_body_156"); // Box 38 glow
		bodyModel[157] = new ModelRendererTurbo(this, 36, 291, textureX, textureY,"interior").setLightFixtureId("interior_body_157"); // Box 38 glow
		bodyModel[158] = new ModelRendererTurbo(this, 45, 291, textureX, textureY,"interior").setLightFixtureId("interior_body_158"); // Box 38 glow
		bodyModel[159] = new ModelRendererTurbo(this, 30, 214, textureX, textureY,"interior").setLightFixtureId("interior_body_159"); // Box 38 glow
		bodyModel[160] = new ModelRendererTurbo(this, 21, 214, textureX, textureY,"interior").setLightFixtureId("interior_body_160"); // Box 38 glow
		...
		bodyModel[247] = new ModelRendererTurbo(this, 58, 297, textureX, textureY,"interior").setLightFixtureId("interior_body_247"); // Box 38 glow
		...
		bodyModel[474] = new ModelRendererTurbo(this, 118, 246, textureX, textureY,"interior").setLightFixtureId("interior_body_474"); // Box 38 glow
		bodyModel[475] = new ModelRendererTurbo(this, 118, 262, textureX, textureY,"interior").setLightFixtureId("interior_body_475"); // Box 38 glow
		bodyModel[476] = new ModelRendererTurbo(this, 258, 331, textureX, textureY,"interior").setLightFixtureId("interior_body_476"); // Box 38 glow
