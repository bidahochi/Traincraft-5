...
public class ModelSW1600 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[137] = new ModelRendererTurbo(this, 126, 185, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_137"); // Box 71 glow speedometer
		...
		bodyModel[268] = new ModelRendererTurbo(this, 190, 150, textureX, textureY, "marker").setLightFixtureId("marker_body_268"); // Box 300 glow marker
		bodyModel[269] = new ModelRendererTurbo(this, 200, 150, textureX, textureY, "marker").setLightFixtureId("marker_body_269"); // Box 348 glow marker
		...
		bodyModel[284] = new ModelRendererTurbo(this, 236, 141, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_284"); // Box 193 numberboard glow
		bodyModel[285] = new ModelRendererTurbo(this, 236, 141, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_285"); // Box 194 numberboard glow
		...
		bodyModel[291] = new ModelRendererTurbo(this, 108, 135, textureX, textureY, "marker").setLightFixtureId("marker_body_291"); // Box 300 glow marker
		bodyModel[292] = new ModelRendererTurbo(this, 98, 135, textureX, textureY, "marker").setLightFixtureId("marker_body_292"); // Box 348 glow marker
		...
		bodyModel[306] = new ModelRendererTurbo(this, 359, 195, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_306"); // Box 275 cs speedo glow
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (GetColor(entity) == 1234) {
			...
			theTrucks1.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 16 ||GetColor(entity) == 6) {
