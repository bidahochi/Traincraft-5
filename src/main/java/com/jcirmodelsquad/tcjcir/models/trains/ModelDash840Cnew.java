...
public class ModelDash840Cnew extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[266] = new ModelRendererTurbo(this, 148, 188, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_266"); // Box 275 cs speedo glow
		bodyModel[267] = new ModelRendererTurbo(this, 108, 185, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_267"); // Box 71 glow speedometer
		...
		bodyModel[270] = new ModelRendererTurbo(this, 143, 188, textureX, textureY, "instrument").setLightFixtureId("cab_signal_body_270"); // Box 412 cab signalling glowey
		...
		bodyModel[322] = new ModelRendererTurbo(this, 180, 121, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_322"); // Box 117 numberboard
		bodyModel[323] = new ModelRendererTurbo(this, 180, 121, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_323"); // Box 118 numberboard
		...
		bodyModel[327] = new ModelRendererTurbo(this, 119, 65, textureX, textureY, "marker").setLightFixtureId("marker_body_327"); // Box 301 markerlight glow
		bodyModel[328] = new ModelRendererTurbo(this, 119, 65, textureX, textureY, "marker").setLightFixtureId("marker_body_328"); // Box 344 markerlight glow
		...
		bodyModel[419] = new ModelRendererTurbo(this, 465, 27, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_419"); // Box 393 numberboard
		bodyModel[420] = new ModelRendererTurbo(this, 465, 27, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_420"); // Box 395 numberboard
		...
		bodyModel[465] = new ModelRendererTurbo(this, 497, 122, textureX, textureY, "marker").setLightFixtureId("marker_crl_body_465"); // Box 339 glow markerlight crl
		bodyModel[466] = new ModelRendererTurbo(this, 497, 122, textureX, textureY, "marker").setLightFixtureId("marker_crl_body_466"); // Box 345 glow markerlight crl
		bodyModel[467] = new ModelRendererTurbo(this, 504, 122, textureX, textureY, "marker").setLightFixtureId("marker_sou_body_467"); // Box 348 glow markerlight sou
		bodyModel[468] = new ModelRendererTurbo(this, 504, 122, textureX, textureY, "marker").setLightFixtureId("marker_sou_body_468"); // Box 349 sou markerlight glow
