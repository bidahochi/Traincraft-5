...
public class ModelHBC1C extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[130] = new ModelRendererTurbo(this, 248, 201, textureX, textureY, "rear_left"); // Box 289 rear light L
		bodyModel[131] = new ModelRendererTurbo(this, 248, 206, textureX, textureY, "rear_right"); // Box 290 rear light R
		bodyModel[132] = new ModelRendererTurbo(this, 257, 194, textureX, textureY); // Box 410
		bodyModel[133] = new ModelRendererTurbo(this, 259, 206, textureX, textureY, "front_right"); // Box 411 front light R
		bodyModel[134] = new ModelRendererTurbo(this, 259, 201, textureX, textureY, "front_left"); // Box 412 front light L
		...
		bodyModel[139] = new ModelRendererTurbo(this, 251, 216, textureX, textureY, "prime_1"); // Box 6 PRIME1-1
		bodyModel[140] = new ModelRendererTurbo(this, 251, 216, textureX, textureY, "prime_3"); // Box 7 PRIME1-3
		bodyModel[141] = new ModelRendererTurbo(this, 251, 216, textureX, textureY, "prime_2"); // Box 8 PRIME1-2
		bodyModel[142] = new ModelRendererTurbo(this, 251, 216, textureX, textureY, "prime_4"); // Box 9 PRIME1-4
		...
		bodyModel[294] = new ModelRendererTurbo(this, 241, 208, textureX, textureY, "rear_right_marker"); // Box 294 markerlight
		bodyModel[295] = new ModelRendererTurbo(this, 241, 208, textureX, textureY, "rear_left_marker"); // Box 294 markerlight
		bodyModel[296] = new ModelRendererTurbo(this, 234, 208, textureX, textureY, "front_left_marker"); // Box 294 markerlight
		bodyModel[297] = new ModelRendererTurbo(this, 234, 208, textureX, textureY, "front_right_marker"); // Box 294 markerlight
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (GetColor(entity) == 14|| GetColor(entity) == 15 ||GetColor(entity) == 7){
			...
			if (GetColor(entity) == 18231 ||GetColor(entity) == 19){
