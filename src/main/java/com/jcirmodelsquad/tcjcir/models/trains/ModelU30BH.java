...
public class ModelU30BH extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[64] = new ModelRendererTurbo(this, 201, 60, textureX, textureY, "front_right_lower"); // Box 190 ditchlight f1
		bodyModel[65] = new ModelRendererTurbo(this, 469, 164, textureX, textureY); // Box 273
		bodyModel[66] = new ModelRendererTurbo(this, 193, 61, textureX, textureY, "front_right_upper"); // Box 275 ditchlight f2
		bodyModel[67] = new ModelRendererTurbo(this, 213, 60, textureX, textureY, "rear_left_lower"); // Box 276 ditchlight r1
		bodyModel[68] = new ModelRendererTurbo(this, 222, 60, textureX, textureY, "rear_left_upper"); // Box 278 ditchlight r2
		bodyModel[69] = new ModelRendererTurbo(this, 4, 71, textureX, textureY, "front_nose_headlight_right"); // Box 247 Headlight Front nose R
		bodyModel[70] = new ModelRendererTurbo(this, 12, 81, textureX, textureY, "front_nose_headlight_left"); // Box 248 Headlight Front nose L
		bodyModel[71] = new ModelRendererTurbo(this, 447, 112, textureX, textureY, "rear_headlight_lower"); // Box 284 Headlight Rear down
		bodyModel[72] = new ModelRendererTurbo(this, 447, 112, textureX, textureY, "rear_headlight_upper"); // Box 285 Headlight Rear up
		...
		bodyModel[96] = new ModelRendererTurbo(this, 1, 65, textureX, textureY, "front_marker_right"); // Box 307 glowey marker
		bodyModel[97] = new ModelRendererTurbo(this, 1, 65, textureX, textureY, "front_marker_left"); // Box 308 glowey marker
		...
		bodyModel[103] = new ModelRendererTurbo(this, 493, 152, textureX, textureY, "rear_marker_lower_right"); // Box 339 glowey marker
		bodyModel[104] = new ModelRendererTurbo(this, 493, 152, textureX, textureY, "rear_marker_lower_left"); // Box 340 glowey marker
		...
		bodyModel[115] = new ModelRendererTurbo(this, 222, 60, textureX, textureY, "rear_right_upper"); // Box 441 ditchlight r2
		bodyModel[116] = new ModelRendererTurbo(this, 213, 65, textureX, textureY); // Box 442
		bodyModel[117] = new ModelRendererTurbo(this, 213, 60, textureX, textureY, "rear_right_lower"); // Box 443 ditchlight r1
		bodyModel[118] = new ModelRendererTurbo(this, 193, 66, textureX, textureY); // Box 444
		bodyModel[119] = new ModelRendererTurbo(this, 193, 61, textureX, textureY, "front_left_upper"); // Box 445 ditchlight f2
		bodyModel[120] = new ModelRendererTurbo(this, 201, 60, textureX, textureY, "front_left_lower"); // Box 446 ditchlight f1
		...
		bodyModel[143] = new ModelRendererTurbo(this, 500, 152, textureX, textureY, "rear_marker_upper_right"); // Box 339 glowey marker
		bodyModel[144] = new ModelRendererTurbo(this, 500, 152, textureX, textureY, "rear_marker_upper_left"); // Box 340 glowey marker
		bodyModel[145] = new ModelRendererTurbo(this, 462, 104, textureX, textureY); // Box 288 rear gyralight mount
		bodyModel[146] = new ModelRendererTurbo(this, 1, 91, textureX, textureY, "rear_gyralite_left"); // Box 289 gyralight rear l
		bodyModel[147] = new ModelRendererTurbo(this, 8, 91, textureX, textureY, "rear_gyralite_right"); // Box 290 gyralight rear r
		...
		bodyModel[203] = new ModelRendererTurbo(this, 481, 109, textureX, textureY, "numberboard"); // Box 165 numberboard
		bodyModel[204] = new ModelRendererTurbo(this, 481, 109, textureX, textureY, "numberboard"); // Box 167 numberboard
		...
		bodyModel[225] = new ModelRendererTurbo(this, 55, 188, textureX, textureY, "cab_speedometer"); // Box 275 cs speedo glow
		...
		bodyModel[246] = new ModelRendererTurbo(this, 12, 86, textureX, textureY, "front_gyralite"); // Box 401 schnoz gyra
		bodyModel[247] = new ModelRendererTurbo(this, 115, 45, textureX, textureY); // Box 355 brakewheel
		bodyModel[248] = new ModelRendererTurbo(this, 39, 54, textureX, textureY, "numberboard"); // Box 117 numberboard
		bodyModel[249] = new ModelRendererTurbo(this, 39, 54, textureX, textureY, "numberboard"); // Box 118 numberboard
		...
		bodyModel[293] = new ModelRendererTurbo(this, 9, 106, textureX, textureY, "front_headlight_upper_phase2"); // Box 186 Headlight Front up ph2
		bodyModel[294] = new ModelRendererTurbo(this, 9, 111, textureX, textureY, "front_headlight_lower_phase2"); // Box 187 Headlight Front down ph2
		...
		bodyModel[299] = new ModelRendererTurbo(this, 22, 190, textureX, textureY, "cab_signal"); // Box 412 cab signalling glowey
		bodyModel[300] = new ModelRendererTurbo(this, 12, 194, textureX, textureY, "cab_speedometer_left"); // Box 71 glow speedometer
		...
		bodyModel[305] = new ModelRendererTurbo(this, 161, 67, textureX, textureY, "commander_right"); // Box 410 commander beacon pw
		bodyModel[306] = new ModelRendererTurbo(this, 154, 67, textureX, textureY, "commander_left"); // Box 342 commander beacon pw
		bodyModel[307] = new ModelRendererTurbo(this, 148, 12, textureX, textureY); // Box 364 prime base
		bodyModel[308] = new ModelRendererTurbo(this, 148, 8, textureX, textureY, "prime_1"); // Box 6 PRIME2-1
		bodyModel[309] = new ModelRendererTurbo(this, 148, 8, textureX, textureY, "prime_3"); // Box 7 PRIME2-3
		bodyModel[310] = new ModelRendererTurbo(this, 148, 8, textureX, textureY, "prime_2"); // Box 8 PRIME2-2
		bodyModel[311] = new ModelRendererTurbo(this, 148, 8, textureX, textureY, "prime_4"); // Box 9 PRIME2-4
