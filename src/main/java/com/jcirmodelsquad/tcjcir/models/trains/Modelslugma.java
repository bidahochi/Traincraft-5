...
public class Modelslugma extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[155] = new ModelRendererTurbo(this, 398, 121, textureX, textureY, "numberboard"); // Box 115 numberboard rear
		bodyModel[156] = new ModelRendererTurbo(this, 398, 121, textureX, textureY, "numberboard"); // Box 116 numberboard rear
		bodyModel[157] = new ModelRendererTurbo(this, 122, 95, textureX, textureY, "marker_body_157"); // Box 559 markerlight
		bodyModel[158] = new ModelRendererTurbo(this, 122, 95, textureX, textureY, "marker_body_158"); // Box 559 markerlight
		bodyModel[159] = new ModelRendererTurbo(this, 395, 124, textureX, textureY, "marker_body_159"); // Box 559 markerlight
		bodyModel[160] = new ModelRendererTurbo(this, 395, 124, textureX, textureY, "marker_body_160"); // Box 559 markerlight
		bodyModel[161] = new ModelRendererTurbo(this, 91, 93, textureX, textureY, "numberboard"); // Box 117 numberboard front high
		bodyModel[162] = new ModelRendererTurbo(this, 91, 93, textureX, textureY, "numberboard"); // Box 118 numberboard front high
