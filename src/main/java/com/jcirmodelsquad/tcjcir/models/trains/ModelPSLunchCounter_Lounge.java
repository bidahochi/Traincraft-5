...
public class ModelPSLunchCounter_Lounge extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[264] = new ModelRendererTurbo(this, 273, 276, textureX, textureY, "interior").setLightFixtureId("interior_body_264"); // Right seat part glow
		bodyModel[265] = new ModelRendererTurbo(this, 262, 276, textureX, textureY, "interior").setLightFixtureId("interior_body_265"); // Right seat part glow
		bodyModel[266] = new ModelRendererTurbo(this, 286, 276, textureX, textureY, "interior").setLightFixtureId("interior_body_266"); // Right seat part glow
		bodyModel[267] = new ModelRendererTurbo(this, 259, 279, textureX, textureY, "interior").setLightFixtureId("interior_body_267"); // Right seat part glow
		bodyModel[268] = new ModelRendererTurbo(this, 291, 279, textureX, textureY, "interior").setLightFixtureId("interior_body_268"); // Right seat part glow
		bodyModel[269] = new ModelRendererTurbo(this, 388, 303, textureX, textureY, "interior").setLightFixtureId("interior_body_269"); // Box 330 glow
		bodyModel[270] = new ModelRendererTurbo(this, 377, 303, textureX, textureY, "interior").setLightFixtureId("interior_body_270"); // Box 331 glow
		bodyModel[271] = new ModelRendererTurbo(this, 405, 306, textureX, textureY, "interior").setLightFixtureId("interior_body_271"); // Box 332 glow
		bodyModel[272] = new ModelRendererTurbo(this, 401, 303, textureX, textureY, "interior").setLightFixtureId("interior_body_272"); // Box 333 glow
		bodyModel[273] = new ModelRendererTurbo(this, 375, 306, textureX, textureY, "interior").setLightFixtureId("interior_body_273"); // Box 334 glow
		...
		bodyModel[320] = new ModelRendererTurbo(this, 399, 309, textureX, textureY, "interior").setLightFixtureId("interior_body_320"); // Box 128 glow
		bodyModel[321] = new ModelRendererTurbo(this, 417, 324, textureX, textureY, "interior").setLightFixtureId("interior_body_321"); // Box 333 glow
		bodyModel[322] = new ModelRendererTurbo(this, 411, 321, textureX, textureY, "interior").setLightFixtureId("interior_body_322"); // Box 333 glow
		...
		bodyModel[333] = new ModelRendererTurbo(this, 191, 315, textureX, textureY, "interior").setLightFixtureId("interior_body_333"); // Box 402 glow
		bodyModel[334] = new ModelRendererTurbo(this, 212, 312, textureX, textureY, "interior").setLightFixtureId("interior_body_334"); // Box 403 glow
		bodyModel[335] = new ModelRendererTurbo(this, 201, 312, textureX, textureY, "interior").setLightFixtureId("interior_body_335"); // Box 404 glow
		...
		bodyModel[374] = new ModelRendererTurbo(this, 355, 338, textureX, textureY, "interior").setLightFixtureId("interior_body_374"); // Box 334 glow
		bodyModel[375] = new ModelRendererTurbo(this, 322, 328, textureX, textureY, "interior").setLightFixtureId("interior_body_375"); // Box 334 glow
		bodyModel[376] = new ModelRendererTurbo(this, 270, 317, textureX, textureY, "interior").setLightFixtureId("interior_body_376"); // Box 334 glow
		...
		bodyModel[409] = new ModelRendererTurbo(this, 403, 248, textureX, textureY, "interior").setLightFixtureId("interior_body_409"); // Box 489 glow
		bodyModel[410] = new ModelRendererTurbo(this, 347, 239, textureX, textureY, "interior").setLightFixtureId("interior_body_410"); // Box 490 glow
		bodyModel[411] = new ModelRendererTurbo(this, 313, 244, textureX, textureY, "interior").setLightFixtureId("interior_body_411"); // Box 491 glow
		...
		bodyModel[428] = new ModelRendererTurbo(this, 44, 267, textureX, textureY, "interior").setLightFixtureId("interior_body_428"); // Right seat part glow
		bodyModel[429] = new ModelRendererTurbo(this, 25, 273, textureX, textureY, "interior").setLightFixtureId("interior_body_429"); // Right seat part glow
		bodyModel[430] = new ModelRendererTurbo(this, 38, 273, textureX, textureY, "interior").setLightFixtureId("interior_body_430"); // Box 128 glow
	...
	private void initbodyModel_2()
	{
		...
		bodyModel[584] = new ModelRendererTurbo(this, 99, 292, textureX, textureY, "interior").setLightFixtureId("interior_body_584"); // Box 334 glow
		...
		bodyModel[591] = new ModelRendererTurbo(this, 84, 260, textureX, textureY, "interior").setLightFixtureId("interior_body_591"); // Box 128 glow
		bodyModel[592] = new ModelRendererTurbo(this, 77, 260, textureX, textureY, "interior").setLightFixtureId("interior_body_592"); // Box 128 glow
		bodyModel[593] = new ModelRendererTurbo(this, 70, 260, textureX, textureY, "interior").setLightFixtureId("interior_body_593"); // Box 128 glow
