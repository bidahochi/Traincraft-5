...
public class ModelC415S extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[81] = new ModelRendererTurbo(this, 25, 138, textureX, textureY, "marker").setLightFixtureId("marker_body_81"); // Box 1521 markerlight
		bodyModel[82] = new ModelRendererTurbo(this, 25, 138, textureX, textureY, "marker").setLightFixtureId("marker_body_82"); // Box 1522 markerlight
		bodyModel[83] = new ModelRendererTurbo(this, 239, 133, textureX, textureY); // Box 1523
		bodyModel[84] = new ModelRendererTurbo(this, 252, 138, textureX, textureY, "marker").setLightFixtureId("marker_body_84"); // Box 1526 markerlight
		bodyModel[85] = new ModelRendererTurbo(this, 252, 138, textureX, textureY, "marker").setLightFixtureId("marker_body_85"); // Box 1527 markerlight
		...
		bodyModel[247] = new ModelRendererTurbo(this, 11, 130, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_247"); // Box 302 numberboard
		bodyModel[248] = new ModelRendererTurbo(this, 11, 130, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_248"); // Box 303 numberboard
		...
		bodyModel[252] = new ModelRendererTurbo(this, 256, 130, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_252"); // Box 302 numberboard
		bodyModel[253] = new ModelRendererTurbo(this, 256, 130, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_253"); // Box 303 numberboard
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (GetColor(entity) == 135461 || GetColor(entity) == 7234 || GetColor(entity) == 8546 || GetColor(entity) == 5546) {
			...
			typeB2.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 3 || GetColor(entity) == 2
				|| GetColor(entity) == 11 || GetColor(entity) == 4
				|| GetColor(entity) == 18234) {
			...
			hiAd.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 13244 || GetColor(entity) == 145) {
