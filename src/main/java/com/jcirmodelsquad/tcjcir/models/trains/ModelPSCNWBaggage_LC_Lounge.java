...
public class ModelPSCNWBaggage_LC_Lounge extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[152] = new ModelRendererTurbo(this, 457, 225, textureX, textureY, "interior"); // Box 384 glow
		...
		bodyModel[204] = new ModelRendererTurbo(this, 351, 229, textureX, textureY, "interior"); // Box 384 glow
		...
		bodyModel[253] = new ModelRendererTurbo(this, 67, 90, textureX, textureY, "marker_lf"); // Box 169 marker lens LF
		bodyModel[254] = new ModelRendererTurbo(this, 57, 90, textureX, textureY, "marker_lr_body_254"); // Box 169 marker lens LR
		bodyModel[255] = new ModelRendererTurbo(this, 62, 71, textureX, textureY); // Box 548
		bodyModel[256] = new ModelRendererTurbo(this, 57, 71, textureX, textureY, "marker_rf"); // Box 549 marker lens RF
		bodyModel[257] = new ModelRendererTurbo(this, 67, 71, textureX, textureY, "marker_lr_body_257"); // Box 547 marker lens LR
		...
		bodyModel[422] = new ModelRendererTurbo(this, 436, 225, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[423] = new ModelRendererTurbo(this, 436, 219, textureX, textureY, "interior"); // Box 511 glow
		bodyModel[424] = new ModelRendererTurbo(this, 437, 221, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[425] = new ModelRendererTurbo(this, 449, 221, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[426] = new ModelRendererTurbo(this, 81, 344, textureX, textureY,"cull"); // Box 514 cull
		bodyModel[427] = new ModelRendererTurbo(this, 388, 231, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[428] = new ModelRendererTurbo(this, 382, 216, textureX, textureY, "interior"); // Box 384 glow
		bodyModel[429] = new ModelRendererTurbo(this, 392, 227, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[430] = new ModelRendererTurbo(this, 382, 223, textureX, textureY, "interior"); // Box 540 glow
		bodyModel[431] = new ModelRendererTurbo(this, 365, 217, textureX, textureY, "interior"); // Box 384 glow
		bodyModel[432] = new ModelRendererTurbo(this, 351, 225, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[433] = new ModelRendererTurbo(this, 351, 231, textureX, textureY, "interior"); // Box 511 glow
		bodyModel[434] = new ModelRendererTurbo(this, 355, 227, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[435] = new ModelRendererTurbo(this, 371, 227, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[436] = new ModelRendererTurbo(this, 343, 229, textureX, textureY, "interior"); // Box 38 glow
	...
	private void initbodyModel_2()
	{
		...
		bodyModel[528] = new ModelRendererTurbo(this, 18, 305, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[529] = new ModelRendererTurbo(this, 23, 274, textureX, textureY, "interior"); // Box 429 glow
