...
public class ModelBuddRDG56SeatCoach_Lounge extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[179] = new ModelRendererTurbo(this, 104, 252, textureX, textureY,"interior").setLightFixtureId("interior_body_179"); // Box 275 glow
		bodyModel[180] = new ModelRendererTurbo(this, 104, 241, textureX, textureY,"interior").setLightFixtureId("interior_body_180"); // Box 285 glow
		...
		bodyModel[207] = new ModelRendererTurbo(this, 84, 202, textureX, textureY,"interior").setLightFixtureId("interior_body_207"); // Box 324 glow
		bodyModel[208] = new ModelRendererTurbo(this, 84, 222, textureX, textureY,"interior").setLightFixtureId("interior_body_208"); // Box 338 glow
		bodyModel[209] = new ModelRendererTurbo(this, 40, 281, textureX, textureY,"interior").setLightFixtureId("interior_body_209"); // Box 128 glow
		bodyModel[210] = new ModelRendererTurbo(this, 40, 317, textureX, textureY,"interior").setLightFixtureId("interior_body_210"); // Box 340 glow
		...
		bodyModel[324] = new ModelRendererTurbo(this, 208, 224, textureX, textureY,"interior").setLightFixtureId("interior_body_324"); // Box 38 glow
		bodyModel[325] = new ModelRendererTurbo(this, 199, 224, textureX, textureY,"interior").setLightFixtureId("interior_body_325"); // Box 38 glow
		bodyModel[326] = new ModelRendererTurbo(this, 190, 224, textureX, textureY,"interior").setLightFixtureId("interior_body_326"); // Box 38 glow
		bodyModel[327] = new ModelRendererTurbo(this, 181, 224, textureX, textureY,"interior").setLightFixtureId("interior_body_327"); // Box 38 glow
		bodyModel[328] = new ModelRendererTurbo(this, 172, 224, textureX, textureY,"interior").setLightFixtureId("interior_body_328"); // Box 38 glow
		bodyModel[329] = new ModelRendererTurbo(this, 163, 224, textureX, textureY,"interior").setLightFixtureId("interior_body_329"); // Box 38 glow
		bodyModel[330] = new ModelRendererTurbo(this, 154, 224, textureX, textureY,"interior").setLightFixtureId("interior_body_330"); // Box 38 glow
		bodyModel[331] = new ModelRendererTurbo(this, 145, 224, textureX, textureY,"interior").setLightFixtureId("interior_body_331"); // Box 38 glow
		bodyModel[332] = new ModelRendererTurbo(this, 136, 224, textureX, textureY,"interior").setLightFixtureId("interior_body_332"); // Box 38 glow
		...
		bodyModel[477] = new ModelRendererTurbo(this, 375, 283, textureX, textureY,"interior").setLightFixtureId("interior_body_477"); // Box 128 glow
