...
public class ModelCF7rouny3 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[134] = new ModelRendererTurbo(this, 348, 111, textureX, textureY, "numberboard"); // Box 117 Numberboard
		bodyModel[135] = new ModelRendererTurbo(this, 348, 111, textureX, textureY, "numberboard"); // Box 118 Numberboard
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		if (GetColor(entity) == 1932||GetColor(entity) == 5||GetColor(entity) == 16
				||GetColor(entity) == 18||GetColor(entity) == 1249||GetColor(entity) == 6324) {
			...
			theBlomb.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 6 || GetColor(entity) == 19) {
			...
			theBlomb.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 7897||GetColor(entity) == 15) {
