...
public class ModelICCBaywindowWP extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[143] = new ModelRendererTurbo(this, 155, 45, textureX, textureY, "front_right_marker"); // Box 410 glow marker
		bodyModel[144] = new ModelRendererTurbo(this, 156, 41, textureX, textureY); // Box 170
		bodyModel[145] = new ModelRendererTurbo(this, 155, 45, textureX, textureY, "front_left_marker"); // Box 410 glow marker
		bodyModel[146] = new ModelRendererTurbo(this, 156, 41, textureX, textureY); // Box 172
		bodyModel[147] = new ModelRendererTurbo(this, 155, 45, textureX, textureY, "rear_right_marker"); // Box 410 glow marker
		bodyModel[148] = new ModelRendererTurbo(this, 156, 41, textureX, textureY); // Box 174
		bodyModel[149] = new ModelRendererTurbo(this, 155, 45, textureX, textureY, "rear_left_marker"); // Box 410 glow marker
		...
		bodyModel[227] = new ModelRendererTurbo(this, 461, 2, textureX, textureY, "rear_center"); // Box 426 glow
		bodyModel[228] = new ModelRendererTurbo(this, 461, 2, textureX, textureY, "front_center"); // Box 250 glow
		...
		bodyModel[244] = new ModelRendererTurbo(this, 374, 119, textureX, textureY, "prime_1"); // Box 6 PRIME4-1
		bodyModel[245] = new ModelRendererTurbo(this, 374, 119, textureX, textureY, "prime_3"); // Box 7 PRIME4-3
		bodyModel[246] = new ModelRendererTurbo(this, 374, 119, textureX, textureY, "prime_2"); // Box 8 PRIME4-2
		bodyModel[247] = new ModelRendererTurbo(this, 374, 119, textureX, textureY, "prime_4"); // Box 9 PRIME4-4
		...
		bodyModel[255] = new ModelRendererTurbo(this, 91, 66, textureX, textureY, "front_right"); // Box 411 front light R
		bodyModel[256] = new ModelRendererTurbo(this, 86, 69, textureX, textureY, "front_left"); // Box 412 front light L
		bodyModel[257] = new ModelRendererTurbo(this, 86, 69, textureX, textureY, "rear_left"); // Box 257
		bodyModel[258] = new ModelRendererTurbo(this, 91, 66, textureX, textureY, "rear_right"); // Box 258
