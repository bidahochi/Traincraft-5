...
public class ModelTB27 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[188] = new ModelRendererTurbo(this, 364, 138, textureX, textureY, "numberboard"); // Box 162 numberboard glow
		bodyModel[189] = new ModelRendererTurbo(this, 359, 142, textureX, textureY, "rear_marker_right"); // Box 161 markerlight glow
		bodyModel[190] = new ModelRendererTurbo(this, 359, 135, textureX, textureY, "rear_marker_left"); // Box 160 markerlight glow
		bodyModel[191] = new ModelRendererTurbo(this, 364, 131, textureX, textureY, "numberboard"); // Box 159 numberboard glow
		...
		bodyModel[195] = new ModelRendererTurbo(this, 346, 133, textureX, textureY, "front_marker_right"); // Box 155 markerlight glow
		bodyModel[196] = new ModelRendererTurbo(this, 326, 139, textureX, textureY, "numberboard"); // Box 154 numberboard glow
		...
		bodyModel[204] = new ModelRendererTurbo(this, 333, 133, textureX, textureY, "front_marker_left"); // Box 150 markerlight glow
		bodyModel[205] = new ModelRendererTurbo(this, 234, 197, textureX, textureY); // Box 149
		bodyModel[206] = new ModelRendererTurbo(this, 339, 139, textureX, textureY, "numberboard"); // Box 145 numberboad glow
		...
		bodyModel[213] = new ModelRendererTurbo(this, 407, 141, textureX, textureY, "numberboard"); // Box 625 sp numerbboard
		bodyModel[214] = new ModelRendererTurbo(this, 391, 141, textureX, textureY, "numberboard"); // Box 626 sp numberboard
		...
		bodyModel[217] = new ModelRendererTurbo(this, 402, 142, textureX, textureY, "front_marker_sp_right"); // Box 254 markerlight glow
		bodyModel[218] = new ModelRendererTurbo(this, 418, 142, textureX, textureY, "front_marker_sp_left"); // Box 264 markerlight glow
		...
		bodyModel[229] = new ModelRendererTurbo(this, 186, 122, textureX, textureY, "rear_headlight_lower_right"); // Box 146 headlight cabend down
		bodyModel[230] = new ModelRendererTurbo(this, 186, 117, textureX, textureY, "rear_headlight_lower_left"); // Box 145 headlight cabend down
		bodyModel[231] = new ModelRendererTurbo(this, 170, 105, textureX, textureY); // Box 144
		bodyModel[232] = new ModelRendererTurbo(this, 179, 112, textureX, textureY, "rear_headlight_upper_right"); // Box 142 headlight cabend up
		bodyModel[233] = new ModelRendererTurbo(this, 186, 112, textureX, textureY, "rear_headlight_upper_left"); // Box 141 headlight cabend up
		bodyModel[234] = new ModelRendererTurbo(this, 179, 105, textureX, textureY); // Box 140
		bodyModel[235] = new ModelRendererTurbo(this, 201, 122, textureX, textureY, "front_headlight_lower"); // Box 149 headlight front 6c
		bodyModel[236] = new ModelRendererTurbo(this, 192, 105, textureX, textureY); // Box 150 chop headlight supportis
		bodyModel[237] = new ModelRendererTurbo(this, 201, 117, textureX, textureY, "front_headlight_upper"); // Box 149 headlight front 5c
		bodyModel[238] = new ModelRendererTurbo(this, 199, 105, textureX, textureY); // Box 612
		bodyModel[239] = new ModelRendererTurbo(this, 194, 112, textureX, textureY, "front_gyralite_right"); // Box 611 gyralight double front sp
		bodyModel[240] = new ModelRendererTurbo(this, 201, 112, textureX, textureY, "front_gyralite_left"); // Box 610 gyralight double front sp
		...
		bodyModel[334] = new ModelRendererTurbo(this, 50, 21, textureX, textureY, "cab_speedometer"); // Box 71 glow speedometer
