...
public class ModelSW9 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[76] = new ModelRendererTurbo(this, 246, 154, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_single_body_76"); // Box 167 numberboard front single
		bodyModel[77] = new ModelRendererTurbo(this, 246, 154, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_single_body_77"); // Box 168 numberboard front single
		...
		bodyModel[141] = new ModelRendererTurbo(this, 293, 121, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_141"); // Box 625 sp numerbboard
		bodyModel[142] = new ModelRendererTurbo(this, 293, 121, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_142"); // Box 626 sp numberboard
		...
		bodyModel[299] = new ModelRendererTurbo(this, 438, 138, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_299"); // Box 275 cs2 speedo glow
		...
		bodyModel[370] = new ModelRendererTurbo(this, 430, 180, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_370"); // Box 71 cs glow speedometer
		bodyModel[371] = new ModelRendererTurbo(this, 430, 175, textureX, textureY); // Box 307 cs speedo
		bodyModel[372] = new ModelRendererTurbo(this, 275, 150, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_double_body_372"); // Box 168 numberboard front double
		bodyModel[373] = new ModelRendererTurbo(this, 275, 150, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_double_body_373"); // Box 167 numberboard front double
		bodyModel[374] = new ModelRendererTurbo(this, 483, 1, textureX, textureY, "numberboard").setLightFixtureId("rear_numberboard_single_body_374"); // Box 167 numberboard rear single
		bodyModel[375] = new ModelRendererTurbo(this, 483, 1, textureX, textureY, "numberboard").setLightFixtureId("rear_numberboard_single_body_375"); // Box 168 numberboard rear single
		bodyModel[376] = new ModelRendererTurbo(this, 482, 22, textureX, textureY, "numberboard").setLightFixtureId("rear_numberboard_double_body_376"); // Box 168 numberboard rear double
		bodyModel[377] = new ModelRendererTurbo(this, 482, 22, textureX, textureY, "numberboard").setLightFixtureId("rear_numberboard_double_body_377"); // Box 167 numberboard rear double
		...
		bodyModel[381] = new ModelRendererTurbo(this, 245, 53, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_381"); // Box 416 more sp numberboard
		...
		bodyModel[385] = new ModelRendererTurbo(this, 245, 49, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_385"); // Box 420 more sp numberboard
		bodyModel[386] = new ModelRendererTurbo(this, 275, 131, textureX, textureY, "marker").setLightFixtureId("marker_crl_body_386"); // Box 422 crl markerlight
		bodyModel[387] = new ModelRendererTurbo(this, 275, 131, textureX, textureY, "marker").setLightFixtureId("marker_crl_body_387"); // Box 422 crl markerlight
		...
		bodyModel[400] = new ModelRendererTurbo(this, 188, 148, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_double_body_400"); // Box 168 numberboard front double
		bodyModel[401] = new ModelRendererTurbo(this, 188, 148, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_double_body_401"); // Box 167 numberboard front double
		...
		bodyModel[479] = new ModelRendererTurbo(this, 275, 134, textureX, textureY, "marker").setLightFixtureId("marker_crl_body_479"); // Box 422 crl markerlight
		bodyModel[480] = new ModelRendererTurbo(this, 275, 134, textureX, textureY, "marker").setLightFixtureId("marker_crl_body_480"); // Box 422 crl markerlight
