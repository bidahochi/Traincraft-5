...
public class ModelPSCNWRPO15_Baggage_LC_Lounge extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[152] = new ModelRendererTurbo(this, 429, 224, textureX, textureY, "interior"); // Box 384 glow
		...
		bodyModel[213] = new ModelRendererTurbo(this, 67, 90, textureX, textureY, "marker_lf"); // Box 169 marker lens LF
		bodyModel[214] = new ModelRendererTurbo(this, 57, 90, textureX, textureY, "marker_lr_body_214"); // Box 169 marker lens LR
		bodyModel[215] = new ModelRendererTurbo(this, 62, 71, textureX, textureY); // Box 548
		bodyModel[216] = new ModelRendererTurbo(this, 57, 71, textureX, textureY, "marker_rf"); // Box 549 marker lens RF
		bodyModel[217] = new ModelRendererTurbo(this, 67, 71, textureX, textureY, "marker_lr_body_217"); // Box 547 marker lens LR
		...
		bodyModel[347] = new ModelRendererTurbo(this, 389, 231, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[348] = new ModelRendererTurbo(this, 383, 216, textureX, textureY, "interior"); // Box 384 glow
		bodyModel[349] = new ModelRendererTurbo(this, 393, 227, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[350] = new ModelRendererTurbo(this, 383, 223, textureX, textureY, "interior"); // Box 540 glow
		bodyModel[351] = new ModelRendererTurbo(this, 366, 217, textureX, textureY, "interior"); // Box 384 glow
		bodyModel[352] = new ModelRendererTurbo(this, 351, 225, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[353] = new ModelRendererTurbo(this, 351, 231, textureX, textureY, "interior"); // Box 511 glow
		bodyModel[354] = new ModelRendererTurbo(this, 355, 227, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[355] = new ModelRendererTurbo(this, 371, 227, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[356] = new ModelRendererTurbo(this, 343, 229, textureX, textureY, "interior"); // Box 38 glow
		...
		bodyModel[440] = new ModelRendererTurbo(this, 96, 305, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[441] = new ModelRendererTurbo(this, 88, 274, textureX, textureY, "interior"); // Box 429 glow
	...
	private void initbodyModel_2()
	{
		...
		bodyModel[552] = new ModelRendererTurbo(this, 12, 389, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[553] = new ModelRendererTurbo(this, 46, 359, textureX, textureY, "interior"); // Box 429 glow
		...
		bodyModel[584] = new ModelRendererTurbo(this, 118, 373, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[585] = new ModelRendererTurbo(this, 120, 369, textureX, textureY); // Box 426
		bodyModel[586] = new ModelRendererTurbo(this, 127, 373, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[587] = new ModelRendererTurbo(this, 129, 369, textureX, textureY); // Box 460
		bodyModel[588] = new ModelRendererTurbo(this, 109, 373, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[589] = new ModelRendererTurbo(this, 95, 373, textureX, textureY, "interior"); // Box 38 glow
		...
		bodyModel[604] = new ModelRendererTurbo(this, 149, 373, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[605] = new ModelRendererTurbo(this, 140, 373, textureX, textureY, "interior"); // Box 38 glow
