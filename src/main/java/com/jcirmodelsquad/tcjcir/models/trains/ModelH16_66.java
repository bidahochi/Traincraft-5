...
public class ModelH16_66 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[215] = new ModelRendererTurbo(this, 51, 42, textureX, textureY,BoxName.marker).setLightFixtureId("marker_fl"); // marker light FL
		bodyModel[216] = new ModelRendererTurbo(this, 15, 42, textureX, textureY,BoxName.marker).setLightFixtureId("marker_fr"); // marker light FR
		bodyModel[217] = new ModelRendererTurbo(this, 341, 303, textureX, textureY,BoxName.marker).setLightFixtureId("marker_rl"); // marker light RL
		bodyModel[218] = new ModelRendererTurbo(this, 405, 303, textureX, textureY,BoxName.marker).setLightFixtureId("marker_rr"); // marker light RR
		...
		bodyModel[479] = new ModelRendererTurbo(this, 83, 20, textureX, textureY,BoxName.marker).setLightFixtureId("marker_fm_body_479"); // marker light FM
		bodyModel[480] = new ModelRendererTurbo(this, 451, 294, textureX, textureY,BoxName.marker).setLightFixtureId("marker_rm"); // marker light RM
		...
		bodyModel[484] = new ModelRendererTurbo(this, 83, 2, textureX, textureY,BoxName.marker).setLightFixtureId("marker_fm_body_484"); // marker light FM
		bodyModel[485] = new ModelRendererTurbo(this, 451, 288, textureX, textureY); // Box 150
		bodyModel[486] = new ModelRendererTurbo(this, 451, 283, textureX, textureY,BoxName.marker).setLightFixtureId("marker_fm_body_486"); // marker light FM
	...
	private void initbodyModel_2()
	{
		...
		bodyModel[527] = new ModelRendererTurbo(this, 83, 13, textureX, textureY,BoxName.marker).setLightFixtureId("marker_fm_body_527"); // marker light FM
