...
public class ModelPS73Baggage extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[120] = new ModelRendererTurbo(this, 94, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_120"); // Box 38 glow
		bodyModel[121] = new ModelRendererTurbo(this, 85, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_121"); // Box 38 glow
		bodyModel[122] = new ModelRendererTurbo(this, 76, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_122"); // Box 38 glow
		bodyModel[123] = new ModelRendererTurbo(this, 67, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_123"); // Box 38 glow
		bodyModel[124] = new ModelRendererTurbo(this, 112, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_124"); // Box 38 glow
		bodyModel[125] = new ModelRendererTurbo(this, 103, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_125"); // Box 38 glow
		bodyModel[126] = new ModelRendererTurbo(this, 130, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_126"); // Box 38 glow
		bodyModel[127] = new ModelRendererTurbo(this, 121, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_127"); // Box 38 glow
		...
		bodyModel[252] = new ModelRendererTurbo(this, 90, 190, textureX, textureY,"interior").setLightFixtureId("interior_body_252"); // Box 38 glow
		bodyModel[253] = new ModelRendererTurbo(this, 119, 190, textureX, textureY,"interior").setLightFixtureId("interior_body_253"); // Box 38 glow
		...
		bodyModel[257] = new ModelRendererTurbo(this, 90, 219, textureX, textureY,"interior").setLightFixtureId("interior_body_257"); // Box 38 glow
		bodyModel[258] = new ModelRendererTurbo(this, 138, 219, textureX, textureY,"interior").setLightFixtureId("interior_body_258"); // Box 38 glow
