...
public class ModelPSRPOPM extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[93] = new ModelRendererTurbo(this, 216, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_93"); // Box 38 glow
		bodyModel[94] = new ModelRendererTurbo(this, 195, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_94"); // Box 38 glow
		bodyModel[95] = new ModelRendererTurbo(this, 85, 200, textureX, textureY,"interior").setLightFixtureId("interior_body_95"); // Box 38 glow
		bodyModel[96] = new ModelRendererTurbo(this, 15, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_96"); // Box 38 glow
		bodyModel[97] = new ModelRendererTurbo(this, 260, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_97"); // Box 38 glow
		bodyModel[98] = new ModelRendererTurbo(this, 242, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_98"); // Box 38 glow
		bodyModel[99] = new ModelRendererTurbo(this, 300, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_99"); // Box 38 glow
		bodyModel[100] = new ModelRendererTurbo(this, 277, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_100"); // Box 38 glow
		...
		bodyModel[182] = new ModelRendererTurbo(this, 28, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_182"); // Box 38 glow
		...
		bodyModel[193] = new ModelRendererTurbo(this, 75, 225, textureX, textureY,"interior").setLightFixtureId("interior_body_193"); // Box 38 glow
		bodyModel[194] = new ModelRendererTurbo(this, 77, 221, textureX, textureY); // Box 426
		bodyModel[195] = new ModelRendererTurbo(this, 74, 191, textureX, textureY,"interior").setLightFixtureId("interior_body_195"); // Box 38 glow
		...
		bodyModel[327] = new ModelRendererTurbo(this, 16, 218, textureX, textureY,"interior").setLightFixtureId("interior_body_327"); // Box 38 glow
		...
		bodyModel[340] = new ModelRendererTurbo(this, 218, 190, textureX, textureY,"interior").setLightFixtureId("interior_body_340"); // Box 38 glow
		bodyModel[341] = new ModelRendererTurbo(this, 271, 190, textureX, textureY,"interior").setLightFixtureId("interior_body_341"); // Box 38 glow
