...
public class ModelDRGWBaggage700Series extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[273] = new ModelRendererTurbo(this, 126, 170, textureX, textureY, "interior"); // Box 11 glow
		bodyModel[274] = new ModelRendererTurbo(this, 137, 166, textureX, textureY); // Box 11
		bodyModel[275] = new ModelRendererTurbo(this, 135, 170, textureX, textureY, "interior"); // Box 11 glow
		bodyModel[276] = new ModelRendererTurbo(this, 173, 166, textureX, textureY); // Box 11
		bodyModel[277] = new ModelRendererTurbo(this, 171, 170, textureX, textureY, "interior"); // Box 11 glow
		bodyModel[278] = new ModelRendererTurbo(this, 182, 166, textureX, textureY); // Box 11
		bodyModel[279] = new ModelRendererTurbo(this, 180, 170, textureX, textureY, "interior"); // Box 11 glow
		bodyModel[280] = new ModelRendererTurbo(this, 155, 166, textureX, textureY); // Box 11
		bodyModel[281] = new ModelRendererTurbo(this, 153, 170, textureX, textureY, "interior"); // Box 11 glow
		bodyModel[282] = new ModelRendererTurbo(this, 164, 166, textureX, textureY); // Box 11
		bodyModel[283] = new ModelRendererTurbo(this, 162, 170, textureX, textureY, "interior"); // Box 11 glow
		bodyModel[284] = new ModelRendererTurbo(this, 146, 166, textureX, textureY); // Box 11
		bodyModel[285] = new ModelRendererTurbo(this, 144, 170, textureX, textureY, "interior"); // Box 11 glow
		...
		bodyModel[457] = new ModelRendererTurbo(this, 81, 238, textureX, textureY, "interior"); // Box 460 glow
		...
		bodyModel[462] = new ModelRendererTurbo(this, 64, 238, textureX, textureY, "interior"); // Box 460 glow
		...
		bodyModel[467] = new ModelRendererTurbo(this, 98, 238, textureX, textureY, "interior"); // Box 460 glow
