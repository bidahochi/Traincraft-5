...
public class ModelOBHWNH5570_5589Baggage extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[128] = new ModelRendererTurbo(this, 167, 268, textureX, textureY,"interior").setLightFixtureId("interior_body_128"); // Box 38 glow
		bodyModel[129] = new ModelRendererTurbo(this, 167, 245, textureX, textureY,"interior").setLightFixtureId("interior_body_129"); // Box 429 glow
		...
		bodyModel[132] = new ModelRendererTurbo(this, 219, 269, textureX, textureY,"interior").setLightFixtureId("interior_body_132"); // Box 38 glow
		bodyModel[133] = new ModelRendererTurbo(this, 234, 245, textureX, textureY,"interior").setLightFixtureId("interior_body_133"); // Box 429 glow
		...
		bodyModel[139] = new ModelRendererTurbo(this, 147, 237, textureX, textureY,"interior").setLightFixtureId("interior_body_139"); // Box 38 glow
		bodyModel[140] = new ModelRendererTurbo(this, 156, 237, textureX, textureY,"interior").setLightFixtureId("interior_body_140"); // Box 38 glow
		bodyModel[141] = new ModelRendererTurbo(this, 165, 237, textureX, textureY,"interior").setLightFixtureId("interior_body_141"); // Box 38 glow
		bodyModel[142] = new ModelRendererTurbo(this, 174, 237, textureX, textureY,"interior").setLightFixtureId("interior_body_142"); // Box 38 glow
		bodyModel[143] = new ModelRendererTurbo(this, 183, 237, textureX, textureY,"interior").setLightFixtureId("interior_body_143"); // Box 38 glow
		...
		bodyModel[295] = new ModelRendererTurbo(this, 119, 237, textureX, textureY,"interior").setLightFixtureId("interior_body_295"); // Box 38 glow
		bodyModel[296] = new ModelRendererTurbo(this, 110, 237, textureX, textureY,"interior").setLightFixtureId("interior_body_296"); // Box 38 glow
		bodyModel[297] = new ModelRendererTurbo(this, 101, 237, textureX, textureY,"interior").setLightFixtureId("interior_body_297"); // Box 38 glow
		bodyModel[298] = new ModelRendererTurbo(this, 128, 237, textureX, textureY,"interior").setLightFixtureId("interior_body_298"); // Box 38 glow
		bodyModel[299] = new ModelRendererTurbo(this, 137, 237, textureX, textureY,"interior").setLightFixtureId("interior_body_299"); // Box 38 glow
		bodyModel[300] = new ModelRendererTurbo(this, 92, 237, textureX, textureY,"interior").setLightFixtureId("interior_body_300"); // Box 38 glow
