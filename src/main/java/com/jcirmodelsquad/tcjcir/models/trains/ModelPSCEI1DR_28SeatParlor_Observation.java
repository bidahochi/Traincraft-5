...
public class ModelPSCEI1DR_28SeatParlor_Observation extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_2()
	{
		...
		bodyModel[511] = new ModelRendererTurbo(this, 352, 94, textureX, textureY, "marker_lense_rr"); // Box 169 marker lense RR
		bodyModel[512] = new ModelRendererTurbo(this, 342, 94, textureX, textureY, "marker_lense_rf"); // Box 169 marker lense RF
		bodyModel[513] = new ModelRendererTurbo(this, 347, 71, textureX, textureY); // Box 548
		bodyModel[514] = new ModelRendererTurbo(this, 352, 71, textureX, textureY, "marker_lense_lr"); // Box 549 marker lense LR
		bodyModel[515] = new ModelRendererTurbo(this, 342, 71, textureX, textureY, "marker_lense_lf"); // Box 547 marker lense LF
		...
		bodyModel[528] = new ModelRendererTurbo(this, 105, 257, textureX, textureY, "interior"); // Box 275 glow
		bodyModel[529] = new ModelRendererTurbo(this, 105, 245, textureX, textureY, "interior"); // Box 285 glow
		bodyModel[530] = new ModelRendererTurbo(this, 93, 262, textureX, textureY); // Box 38
		bodyModel[531] = new ModelRendererTurbo(this, 45, 252, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[532] = new ModelRendererTurbo(this, 52, 252, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[533] = new ModelRendererTurbo(this, 59, 252, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[534] = new ModelRendererTurbo(this, 66, 252, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[535] = new ModelRendererTurbo(this, 73, 252, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[536] = new ModelRendererTurbo(this, 80, 252, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[537] = new ModelRendererTurbo(this, 87, 252, textureX, textureY, "interior"); // Box 38 glow
		...
		bodyModel[582] = new ModelRendererTurbo(this, 488, 349, textureX, textureY, "interior"); // Box 275 glow
		...
		bodyModel[585] = new ModelRendererTurbo(this, 488, 326, textureX, textureY, "interior"); // Box 613 glow
		bodyModel[586] = new ModelRendererTurbo(this, 78, 245, textureX, textureY, "interior"); // Box 275 glow
		bodyModel[587] = new ModelRendererTurbo(this, 82, 245, textureX, textureY, "interior"); // Box 275 glow
		bodyModel[588] = new ModelRendererTurbo(this, 88, 247, textureX, textureY, "interior"); // Box 275 glow
		...
		bodyModel[610] = new ModelRendererTurbo(this, 84, 302, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[611] = new ModelRendererTurbo(this, 84, 276, textureX, textureY, "interior"); // Box 38 glow
		...
		bodyModel[642] = new ModelRendererTurbo(this, 25, 248, textureX, textureY, "interior"); // Box 275 glow
		bodyModel[643] = new ModelRendererTurbo(this, 38, 255, textureX, textureY, "interior"); // Box 275 glow
		bodyModel[644] = new ModelRendererTurbo(this, 38, 253, textureX, textureY, "interior"); // Box 275 glow
		bodyModel[645] = new ModelRendererTurbo(this, 41, 253, textureX, textureY, "interior"); // Box 275 glow
		bodyModel[646] = new ModelRendererTurbo(this, 32, 253, textureX, textureY, "interior"); // Box 275 glow
