...
public class ModelPScenterDiner extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[283] = new ModelRendererTurbo(this, 84, 226, textureX, textureY,"interior").setLightFixtureId("interior_body_283"); // Box 128 glow
		bodyModel[284] = new ModelRendererTurbo(this, 84, 213, textureX, textureY,"interior").setLightFixtureId("interior_body_284"); // Box 440 glow
		bodyModel[285] = new ModelRendererTurbo(this, 430, 294, textureX, textureY); // Box 128
		bodyModel[286] = new ModelRendererTurbo(this, 440, 282, textureX, textureY,"interior").setLightFixtureId("interior_body_286"); // Box 128 glow
		bodyModel[287] = new ModelRendererTurbo(this, 440, 285, textureX, textureY,"interior").setLightFixtureId("interior_body_287"); // Box 440 glow
		...
		bodyModel[474] = new ModelRendererTurbo(this, 480, 290, textureX, textureY,"interior").setLightFixtureId("interior_body_474"); // Box 128 glow
		bodyModel[475] = new ModelRendererTurbo(this, 475, 291, textureX, textureY,"interior").setLightFixtureId("interior_body_475"); // Box 128 glow
		bodyModel[476] = new ModelRendererTurbo(this, 475, 288, textureX, textureY,"interior").setLightFixtureId("interior_body_476"); // Box 128 glow
		bodyModel[477] = new ModelRendererTurbo(this, 470, 291, textureX, textureY,"interior").setLightFixtureId("interior_body_477"); // Box 128 glow
		bodyModel[478] = new ModelRendererTurbo(this, 470, 288, textureX, textureY,"interior").setLightFixtureId("interior_body_478"); // Box 128 glow
