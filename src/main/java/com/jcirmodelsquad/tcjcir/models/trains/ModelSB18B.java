...
public class ModelSB18B extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[81] = new ModelRendererTurbo(this, 359, 91, textureX, textureY, "marker").setLightFixtureId("marker_body_81"); // Box 339 glowey marker
		bodyModel[82] = new ModelRendererTurbo(this, 359, 91, textureX, textureY, "marker").setLightFixtureId("marker_body_82"); // Box 340 glowey marker
		...
		bodyModel[219] = new ModelRendererTurbo(this, 133, 68, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_219"); // Box 117 Numberboard
		bodyModel[220] = new ModelRendererTurbo(this, 133, 68, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_220"); // Box 118 Numberboard
		...
		bodyModel[227] = new ModelRendererTurbo(this, 346, 88, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_227"); // Box 117 Numberboard
		bodyModel[228] = new ModelRendererTurbo(this, 346, 88, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_228"); // Box 118 Numberboard
		...
		bodyModel[231] = new ModelRendererTurbo(this, 201, 167, textureX, textureY, "marker").setLightFixtureId("marker_body_231"); // Box 71 markerlight cull
		bodyModel[232] = new ModelRendererTurbo(this, 201, 167, textureX, textureY, "marker").setLightFixtureId("marker_body_232"); // Box 124 markerlight cull
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (GetColor(entity) == 3426||GetColor(entity) == 7324) {
			...
			theTrucks4.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 7 ||GetColor(entity) == 3234){
