...
public class ModelACFGN1DR_17SeatParlorObservation extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[175] = new ModelRendererTurbo(this, 380, 104, textureX, textureY,"lamp"); // tail sign glow
		...
		bodyModel[196] = new ModelRendererTurbo(this, 444, 42, textureX, textureY,"lamp"); // Box 186 rear MARS light R
		bodyModel[197] = new ModelRendererTurbo(this, 444, 48, textureX, textureY,"lamp"); // Box 187 rear MARS light W
		...
		bodyModel[203] = new ModelRendererTurbo(this, 352, 72, textureX, textureY, "marker_body_203"); // marker light glow
		...
		bodyModel[206] = new ModelRendererTurbo(this, 352, 87, textureX, textureY, "marker_body_206"); // marker light glow
		...
		bodyModel[309] = new ModelRendererTurbo(this, 341, 228, textureX, textureY, "interior"); // Box 275 glow
		bodyModel[310] = new ModelRendererTurbo(this, 342, 231, textureX, textureY); // Box 275
		bodyModel[311] = new ModelRendererTurbo(this, 327, 220, textureX, textureY, "interior"); // Box 485 glow
		bodyModel[312] = new ModelRendererTurbo(this, 328, 223, textureX, textureY); // Box 486
		bodyModel[313] = new ModelRendererTurbo(this, 466, 228, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[314] = new ModelRendererTurbo(this, 468, 231, textureX, textureY); // Box 38
		bodyModel[315] = new ModelRendererTurbo(this, 466, 220, textureX, textureY, "interior"); // Box 490 glow
		bodyModel[316] = new ModelRendererTurbo(this, 467, 223, textureX, textureY); // Box 491
		bodyModel[317] = new ModelRendererTurbo(this, 485, 228, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[318] = new ModelRendererTurbo(this, 486, 231, textureX, textureY); // Box 38
		bodyModel[319] = new ModelRendererTurbo(this, 485, 220, textureX, textureY, "interior"); // Box 495 glow
		bodyModel[320] = new ModelRendererTurbo(this, 486, 223, textureX, textureY); // Box 496
		bodyModel[321] = new ModelRendererTurbo(this, 494, 225, textureX, textureY, "interior"); // Box 2 glow
		bodyModel[322] = new ModelRendererTurbo(this, 496, 228, textureX, textureY); // Box 2
		bodyModel[323] = new ModelRendererTurbo(this, 494, 217, textureX, textureY, "interior"); // Box 506 glow
		bodyModel[324] = new ModelRendererTurbo(this, 496, 220, textureX, textureY); // Box 507
		bodyModel[325] = new ModelRendererTurbo(this, 505, 227, textureX, textureY, "interior"); // Box 2 glow
		bodyModel[326] = new ModelRendererTurbo(this, 506, 229, textureX, textureY); // Box 2
		bodyModel[327] = new ModelRendererTurbo(this, 505, 219, textureX, textureY, "interior"); // Box 510 glow
	...
	private void initbodyModel_2()
	{
		...
		bodyModel[568] = new ModelRendererTurbo(this, 31, 237, textureX, textureY, "interior"); // Box 128 glow
		bodyModel[569] = new ModelRendererTurbo(this, 27, 237, textureX, textureY, "interior"); // Box 128 glow
		bodyModel[570] = new ModelRendererTurbo(this, 20, 237, textureX, textureY, "interior"); // Box 128 glow
		...
		bodyModel[580] = new ModelRendererTurbo(this, 1, 237, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[581] = new ModelRendererTurbo(this, 15, 237, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[582] = new ModelRendererTurbo(this, 8, 237, textureX, textureY, "interior"); // Box 38 glow
		...
		bodyModel[585] = new ModelRendererTurbo(this, 239, 250, textureX, textureY, "interior"); // Box 462 glow
		bodyModel[586] = new ModelRendererTurbo(this, 239, 239, textureX, textureY, "interior"); // Box 462 glow
		...
		bodyModel[650] = new ModelRendererTurbo(this, 397, 105, textureX, textureY,"lamp"); // tail sign glow
		bodyModel[651] = new ModelRendererTurbo(this, 458, 48, textureX, textureY,"lamp"); // Box 186 rear MARS light AMTK L
		...
		bodyModel[655] = new ModelRendererTurbo(this, 352, 77, textureX, textureY, "marker_amtk_body_655"); // marker light AMTK glow
		bodyModel[656] = new ModelRendererTurbo(this, 347, 77, textureX, textureY); // Box 38
		bodyModel[657] = new ModelRendererTurbo(this, 352, 92, textureX, textureY, "marker_amtk_body_657"); // marker light AMTK glow
		...
		bodyModel[714] = new ModelRendererTurbo(this, 23, 237, textureX, textureY, "interior"); // Box 128 glow
