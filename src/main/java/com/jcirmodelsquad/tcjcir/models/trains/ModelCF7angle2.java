...
public class ModelCF7angle2 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[118] = new ModelRendererTurbo(this, 251, 92, textureX, textureY, "numberboard"); // Box 117 Numberboard R
		bodyModel[119] = new ModelRendererTurbo(this, 251, 92, textureX, textureY, "numberboard"); // Box 118 Numberboard R
		...
		bodyModel[138] = new ModelRendererTurbo(this, 348, 111, textureX, textureY, "numberboard"); // Box 117 Numberboard
		bodyModel[139] = new ModelRendererTurbo(this, 348, 111, textureX, textureY, "numberboard"); // Box 118 Numberboard
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		if (GetColor(entity) == 11||GetColor(entity) == 5
				||GetColor(entity) == 17||GetColor(entity) == 19
				||GetColor(entity) == 21||GetColor(entity) == 22
				||GetColor(entity) == 20||GetColor(entity) == 6
				||GetColor(entity) == 13||GetColor(entity) == 27
				||GetColor(entity) == 29||GetColor(entity) == 40
		) {
			...
			theBlomb.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 23||GetColor(entity) == 7) {
			...
			theBlomb.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 25||GetColor(entity) == 15||GetColor(entity) == 31) {
