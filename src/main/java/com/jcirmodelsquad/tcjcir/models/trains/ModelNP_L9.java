...
public class ModelNP_L9 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[276] = new ModelRendererTurbo(this, 36, 7, textureX, textureY, "numberboard"); // Box 2 headlight 1 number boards glow
		bodyModel[277] = new ModelRendererTurbo(this, 35, 14, textureX, textureY, "numberboard"); // Box 2 headlight 1 number boards glow
		bodyModel[278] = new ModelRendererTurbo(this, 35, 14, textureX, textureY, "numberboard"); // Box 2 headlight 1 number boards glow
		...
		bodyModel[286] = new ModelRendererTurbo(this, 17, 11, textureX, textureY, "numberboard"); // Box 2 headlight 2 number boards glow
		bodyModel[287] = new ModelRendererTurbo(this, 29, 8, textureX, textureY); // Box 2 headlight 2
		bodyModel[288] = new ModelRendererTurbo(this, 17, 11, textureX, textureY, "numberboard"); // Box 2 headlight 2 number boards glow
