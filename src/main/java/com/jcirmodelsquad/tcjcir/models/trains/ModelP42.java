...
public class ModelP42 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[399] = new ModelRendererTurbo(this, 469, 94, textureX, textureY, "rear_marker_lightt_body_399"); // Box 2 rear marker lightt glow
		bodyModel[400] = new ModelRendererTurbo(this, 493, 94, textureX, textureY, "rear_marker_lightt_body_400"); // Box 2 rear marker lightt glow
		...
		bodyModel[428] = new ModelRendererTurbo(this, 44, 86, textureX, textureY, "numberboard"); // Box 2 number board glow
		bodyModel[429] = new ModelRendererTurbo(this, 52, 86, textureX, textureY, "numberboard"); // Box 2 number board glow
