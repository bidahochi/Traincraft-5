...
public class ModelBuddRDGDiner_Lounge extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[159] = new ModelRendererTurbo(this, 84, 202, textureX, textureY, "interior"); // Box 324 glow
		bodyModel[160] = new ModelRendererTurbo(this, 84, 222, textureX, textureY, "interior"); // Box 338 glow
		bodyModel[161] = new ModelRendererTurbo(this, 247, 226, textureX, textureY, "interior"); // Box 128 glow
		bodyModel[162] = new ModelRendererTurbo(this, 247, 249, textureX, textureY, "interior"); // Box 340 glow
		bodyModel[163] = new ModelRendererTurbo(this, 190, 224, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[164] = new ModelRendererTurbo(this, 181, 224, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[165] = new ModelRendererTurbo(this, 172, 224, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[166] = new ModelRendererTurbo(this, 163, 224, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[167] = new ModelRendererTurbo(this, 154, 224, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[168] = new ModelRendererTurbo(this, 145, 224, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[169] = new ModelRendererTurbo(this, 136, 224, textureX, textureY, "interior"); // Box 38 glow
		...
		bodyModel[280] = new ModelRendererTurbo(this, 73, 347, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[281] = new ModelRendererTurbo(this, 75, 344, textureX, textureY); // Box 426
		bodyModel[282] = new ModelRendererTurbo(this, 82, 347, textureX, textureY, "interior"); // Box 38 glow
		...
		bodyModel[295] = new ModelRendererTurbo(this, 138, 314, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[296] = new ModelRendererTurbo(this, 182, 320, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[297] = new ModelRendererTurbo(this, 152, 341, textureX, textureY, "interior"); // Box 38 glow
		...
		bodyModel[369] = new ModelRendererTurbo(this, 248, 256, textureX, textureY, "interior"); // Box 329 glow
		bodyModel[370] = new ModelRendererTurbo(this, 247, 228, textureX, textureY); // Box 329
		bodyModel[371] = new ModelRendererTurbo(this, 248, 233, textureX, textureY, "interior"); // Box 329 glow
	...
	private void initbodyModel_2()
	{
		...
		bodyModel[523] = new ModelRendererTurbo(this, 220, 312, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[524] = new ModelRendererTurbo(this, 197, 307, textureX, textureY, "interior"); // Box 38 glow
		bodyModel[525] = new ModelRendererTurbo(this, 200, 305, textureX, textureY, "interior"); // Box 38 glow
