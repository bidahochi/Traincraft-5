...
public class ModelDRGWCoach1005Series extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[416] = new ModelRendererTurbo(this, 176, 226, textureX, textureY,"interior").setLightFixtureId("interior_body_416"); // Box 11 glow
		bodyModel[417] = new ModelRendererTurbo(this, 176, 230, textureX, textureY,"interior").setLightFixtureId("interior_body_417"); // Box 11 glow
		bodyModel[418] = new ModelRendererTurbo(this, 185, 226, textureX, textureY,"interior").setLightFixtureId("interior_body_418"); // Box 11 glow
		bodyModel[419] = new ModelRendererTurbo(this, 185, 230, textureX, textureY,"interior").setLightFixtureId("interior_body_419"); // Box 11 glow
		bodyModel[420] = new ModelRendererTurbo(this, 194, 226, textureX, textureY,"interior").setLightFixtureId("interior_body_420"); // Box 11 glow
		bodyModel[421] = new ModelRendererTurbo(this, 194, 230, textureX, textureY,"interior").setLightFixtureId("interior_body_421"); // Box 11 glow
		bodyModel[422] = new ModelRendererTurbo(this, 203, 226, textureX, textureY,"interior").setLightFixtureId("interior_body_422"); // Box 11 glow
		bodyModel[423] = new ModelRendererTurbo(this, 203, 230, textureX, textureY,"interior").setLightFixtureId("interior_body_423"); // Box 11 glow
		bodyModel[424] = new ModelRendererTurbo(this, 212, 226, textureX, textureY,"interior").setLightFixtureId("interior_body_424"); // Box 11 glow
		bodyModel[425] = new ModelRendererTurbo(this, 212, 230, textureX, textureY,"interior").setLightFixtureId("interior_body_425"); // Box 11 glow
		bodyModel[426] = new ModelRendererTurbo(this, 221, 226, textureX, textureY,"interior").setLightFixtureId("interior_body_426"); // Box 11 glow
		bodyModel[427] = new ModelRendererTurbo(this, 221, 230, textureX, textureY,"interior").setLightFixtureId("interior_body_427"); // Box 11 glow
		bodyModel[428] = new ModelRendererTurbo(this, 230, 226, textureX, textureY,"interior").setLightFixtureId("interior_body_428"); // Box 11 glow
		bodyModel[429] = new ModelRendererTurbo(this, 230, 230, textureX, textureY,"interior").setLightFixtureId("interior_body_429"); // Box 11 glow
		bodyModel[430] = new ModelRendererTurbo(this, 239, 226, textureX, textureY,"interior").setLightFixtureId("interior_body_430"); // Box 11 glow
		bodyModel[431] = new ModelRendererTurbo(this, 239, 230, textureX, textureY,"interior").setLightFixtureId("interior_body_431"); // Box 11 glow
