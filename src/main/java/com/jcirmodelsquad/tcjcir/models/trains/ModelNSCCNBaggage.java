...
public class ModelNSCCNBaggage extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[84] = new ModelRendererTurbo(this, 82, 201, textureX, textureY,"interior").setLightFixtureId("interior_body_84"); // Box 38 glow
		bodyModel[85] = new ModelRendererTurbo(this, 73, 201, textureX, textureY,"interior").setLightFixtureId("interior_body_85"); // Box 38 glow
		bodyModel[86] = new ModelRendererTurbo(this, 64, 201, textureX, textureY,"interior").setLightFixtureId("interior_body_86"); // Box 38 glow
		bodyModel[87] = new ModelRendererTurbo(this, 100, 201, textureX, textureY,"interior").setLightFixtureId("interior_body_87"); // Box 38 glow
		bodyModel[88] = new ModelRendererTurbo(this, 91, 201, textureX, textureY,"interior").setLightFixtureId("interior_body_88"); // Box 38 glow
		bodyModel[89] = new ModelRendererTurbo(this, 118, 201, textureX, textureY,"interior").setLightFixtureId("interior_body_89"); // Box 38 glow
		bodyModel[90] = new ModelRendererTurbo(this, 109, 201, textureX, textureY,"interior").setLightFixtureId("interior_body_90"); // Box 38 glow
