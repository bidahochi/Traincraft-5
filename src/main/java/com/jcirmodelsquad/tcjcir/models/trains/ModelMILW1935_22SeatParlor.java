...
public class ModelMILW1935_22SeatParlor extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[334] = new ModelRendererTurbo(this, 454, 278, textureX, textureY,"interior").setLightFixtureId("interior_body_334"); // Box 309 glow
		bodyModel[335] = new ModelRendererTurbo(this, 448, 245, textureX, textureY,"interior").setLightFixtureId("interior_body_335"); // Box 38 glow
		bodyModel[336] = new ModelRendererTurbo(this, 434, 252, textureX, textureY,"interior").setLightFixtureId("interior_body_336"); // Box 309 glow
		bodyModel[337] = new ModelRendererTurbo(this, 460, 252, textureX, textureY,"interior").setLightFixtureId("interior_body_337"); // Box 309 glow
		bodyModel[338] = new ModelRendererTurbo(this, 69, 276, textureX, textureY,"interior").setLightFixtureId("interior_body_338"); // Box 309 glow
		bodyModel[339] = new ModelRendererTurbo(this, 76, 276, textureX, textureY,"interior").setLightFixtureId("interior_body_339"); // Box 309 glow
