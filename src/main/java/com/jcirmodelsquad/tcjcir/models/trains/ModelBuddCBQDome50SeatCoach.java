...
public class ModelBuddCBQDome50SeatCoach extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[408] = new ModelRendererTurbo(this, 1, 372, textureX, textureY,"interior").setLightFixtureId("interior_body_408"); // Box 38 glow
		bodyModel[409] = new ModelRendererTurbo(this, 3, 401, textureX, textureY,"interior").setLightFixtureId("interior_body_409"); // Box 38 glow
		bodyModel[410] = new ModelRendererTurbo(this, 101, 297, textureX, textureY,"interior").setLightFixtureId("interior_body_410"); // Box 38 glow
		bodyModel[411] = new ModelRendererTurbo(this, 97, 335, textureX, textureY,"interior").setLightFixtureId("interior_body_411"); // Box 38 glow
		bodyModel[412] = new ModelRendererTurbo(this, 85, 263, textureX, textureY,"interior").setLightFixtureId("interior_body_412"); // Box 128 glow
		bodyModel[413] = new ModelRendererTurbo(this, 36, 343, textureX, textureY,"interior").setLightFixtureId("interior_body_413"); // Box 128 glow
		bodyModel[414] = new ModelRendererTurbo(this, 45, 351, textureX, textureY,"interior").setLightFixtureId("interior_body_414"); // Box 38 glow
		bodyModel[415] = new ModelRendererTurbo(this, 1, 351, textureX, textureY,"interior").setLightFixtureId("interior_body_415"); // Box 38 glow
		bodyModel[416] = new ModelRendererTurbo(this, 49, 348, textureX, textureY,"interior").setLightFixtureId("interior_body_416"); // Box 38 glow
		bodyModel[417] = new ModelRendererTurbo(this, 150, 277, textureX, textureY,"interior").setLightFixtureId("interior_body_417"); // Box 38 glow
		bodyModel[418] = new ModelRendererTurbo(this, 128, 277, textureX, textureY,"interior").setLightFixtureId("interior_body_418"); // Box 38 glow
		bodyModel[419] = new ModelRendererTurbo(this, 139, 277, textureX, textureY,"interior").setLightFixtureId("interior_body_419"); // Box 38 glow
		bodyModel[420] = new ModelRendererTurbo(this, 172, 227, textureX, textureY,"interior").setLightFixtureId("interior_body_420"); // Box 38 glow
		bodyModel[421] = new ModelRendererTurbo(this, 172, 236, textureX, textureY,"interior").setLightFixtureId("interior_body_421"); // Box 950 glow
	...
	private void initbodyModel_2()
	{
		...
		bodyModel[621] = new ModelRendererTurbo(this, 161, 275, textureX, textureY,"interior").setLightFixtureId("interior_body_621"); // Box 38 glow
		bodyModel[622] = new ModelRendererTurbo(this, 34, 351, textureX, textureY,"interior").setLightFixtureId("interior_body_622"); // Box 38 glow
		bodyModel[623] = new ModelRendererTurbo(this, 12, 351, textureX, textureY,"interior").setLightFixtureId("interior_body_623"); // Box 38 glow
