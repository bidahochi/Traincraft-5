...
public class ModelFourCorTrailerSecond extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[289] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_289"); // Ceiling Lamp
		bodyModel[290] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_290"); // Ceiling Lamp
		bodyModel[291] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_291"); // Ceiling Lamp
		bodyModel[292] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_292"); // Ceiling Lamp
		bodyModel[293] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_293"); // Ceiling Lamp
		bodyModel[294] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_294"); // Ceiling Lamp
		bodyModel[295] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_295"); // Ceiling Lamp
		bodyModel[296] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_296"); // Ceiling Lamp
		bodyModel[297] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_297"); // Ceiling Lamp
		bodyModel[298] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_298"); // Ceiling Lamp
		bodyModel[299] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_299"); // Ceiling Lamp
		bodyModel[300] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_300"); // Ceiling Lamp
		bodyModel[301] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_301"); // Ceiling Lamp
		bodyModel[302] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_302"); // Ceiling Lamp
		bodyModel[303] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_303"); // Ceiling Lamp
		bodyModel[304] = new ModelRendererTurbo(this, 1, 197, textureX, textureY,"interior").setLightFixtureId("interior_body_304"); // Ceiling Lamp
