...
public class ModelDRGWBaggage740Series extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[244] = new ModelRendererTurbo(this, 148, 170, textureX, textureY,"interior").setLightFixtureId("interior_body_244"); // Box 11 glow
		bodyModel[245] = new ModelRendererTurbo(this, 159, 166, textureX, textureY); // Box 11
		bodyModel[246] = new ModelRendererTurbo(this, 157, 170, textureX, textureY,"interior").setLightFixtureId("interior_body_246"); // Box 11 glow
		bodyModel[247] = new ModelRendererTurbo(this, 195, 166, textureX, textureY); // Box 11
		bodyModel[248] = new ModelRendererTurbo(this, 193, 170, textureX, textureY,"interior").setLightFixtureId("interior_body_248"); // Box 11 glow
		bodyModel[249] = new ModelRendererTurbo(this, 204, 166, textureX, textureY); // Box 11
		bodyModel[250] = new ModelRendererTurbo(this, 202, 170, textureX, textureY,"interior").setLightFixtureId("interior_body_250"); // Box 11 glow
		bodyModel[251] = new ModelRendererTurbo(this, 177, 166, textureX, textureY); // Box 11
		bodyModel[252] = new ModelRendererTurbo(this, 175, 170, textureX, textureY,"interior").setLightFixtureId("interior_body_252"); // Box 11 glow
		bodyModel[253] = new ModelRendererTurbo(this, 186, 166, textureX, textureY); // Box 11
		bodyModel[254] = new ModelRendererTurbo(this, 184, 170, textureX, textureY,"interior").setLightFixtureId("interior_body_254"); // Box 11 glow
		bodyModel[255] = new ModelRendererTurbo(this, 168, 166, textureX, textureY); // Box 11
		bodyModel[256] = new ModelRendererTurbo(this, 166, 170, textureX, textureY,"interior").setLightFixtureId("interior_body_256"); // Box 11 glow
		...
		bodyModel[379] = new ModelRendererTurbo(this, 139, 170, textureX, textureY,"interior").setLightFixtureId("interior_body_379"); // Box 11 glow
