...
public class ModelOBRPO15 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[278] = new ModelRendererTurbo(this, 12, 389, textureX, textureY,"interior").setLightFixtureId("interior_body_278"); // Box 38 glow
		bodyModel[279] = new ModelRendererTurbo(this, 46, 359, textureX, textureY,"interior").setLightFixtureId("interior_body_279"); // Box 429 glow
		...
		bodyModel[298] = new ModelRendererTurbo(this, 118, 373, textureX, textureY,"interior").setLightFixtureId("interior_body_298"); // Box 38 glow
		bodyModel[299] = new ModelRendererTurbo(this, 120, 369, textureX, textureY); // Box 426
		bodyModel[300] = new ModelRendererTurbo(this, 127, 373, textureX, textureY,"interior").setLightFixtureId("interior_body_300"); // Box 38 glow
		bodyModel[301] = new ModelRendererTurbo(this, 129, 369, textureX, textureY); // Box 460
		bodyModel[302] = new ModelRendererTurbo(this, 109, 373, textureX, textureY,"interior").setLightFixtureId("interior_body_302"); // Box 38 glow
		...
		bodyModel[418] = new ModelRendererTurbo(this, 97, 313, textureX, textureY,"interior").setLightFixtureId("interior_body_418"); // Box 38 glow
		bodyModel[419] = new ModelRendererTurbo(this, 97, 268, textureX, textureY,"interior").setLightFixtureId("interior_body_419"); // Box 429 glow
		...
		bodyModel[430] = new ModelRendererTurbo(this, 268, 313, textureX, textureY,"interior").setLightFixtureId("interior_body_430"); // Box 38 glow
		bodyModel[431] = new ModelRendererTurbo(this, 268, 267, textureX, textureY,"interior").setLightFixtureId("interior_body_431"); // Box 429 glow
		...
		bodyModel[452] = new ModelRendererTurbo(this, 95, 248, textureX, textureY,"interior").setLightFixtureId("interior_body_452"); // Box 38 glow
		bodyModel[453] = new ModelRendererTurbo(this, 104, 248, textureX, textureY,"interior").setLightFixtureId("interior_body_453"); // Box 38 glow
		bodyModel[454] = new ModelRendererTurbo(this, 113, 248, textureX, textureY,"interior").setLightFixtureId("interior_body_454"); // Box 38 glow
		bodyModel[455] = new ModelRendererTurbo(this, 122, 248, textureX, textureY,"interior").setLightFixtureId("interior_body_455"); // Box 38 glow
		bodyModel[456] = new ModelRendererTurbo(this, 131, 248, textureX, textureY,"interior").setLightFixtureId("interior_body_456"); // Box 38 glow
		...
		bodyModel[467] = new ModelRendererTurbo(this, 100, 373, textureX, textureY,"interior").setLightFixtureId("interior_body_467"); // Box 38 glow
