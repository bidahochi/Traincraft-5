...
public class ModelTR4B extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[57] = new ModelRendererTurbo(this, 246, 154, textureX, textureY,"numberboard").setLightFixtureId("front_numberboard_single_body_57"); // Box 167 numberboard front single
		bodyModel[58] = new ModelRendererTurbo(this, 246, 154, textureX, textureY,"numberboard").setLightFixtureId("front_numberboard_single_body_58"); // Box 168 numberboard front single
		...
		bodyModel[103] = new ModelRendererTurbo(this, 293, 121, textureX, textureY,"numberboard").setLightFixtureId("numberboard_body_103"); // Box 625 sp numerbboard
		bodyModel[104] = new ModelRendererTurbo(this, 293, 121, textureX, textureY,"numberboard").setLightFixtureId("numberboard_body_104"); // Box 626 sp numberboard
		...
		bodyModel[246] = new ModelRendererTurbo(this, 275, 150, textureX, textureY,"numberboard").setLightFixtureId("front_numberboard_double_body_246"); // Box 168 numberboard front double
		bodyModel[247] = new ModelRendererTurbo(this, 275, 150, textureX, textureY,"numberboard").setLightFixtureId("front_numberboard_double_body_247"); // Box 167 numberboard front double
		bodyModel[248] = new ModelRendererTurbo(this, 483, 1, textureX, textureY,"numberboard").setLightFixtureId("rear_numberboard_single_body_248"); // Box 167 numberboard rear single
		bodyModel[249] = new ModelRendererTurbo(this, 483, 1, textureX, textureY,"numberboard").setLightFixtureId("rear_numberboard_single_body_249"); // Box 168 numberboard rear single
		bodyModel[250] = new ModelRendererTurbo(this, 482, 22, textureX, textureY,"numberboard").setLightFixtureId("rear_numberboard_double_body_250"); // Box 168 numberboard rear double
		bodyModel[251] = new ModelRendererTurbo(this, 482, 22, textureX, textureY,"numberboard").setLightFixtureId("rear_numberboard_double_body_251"); // Box 167 numberboard rear double
		bodyModel[252] = new ModelRendererTurbo(this, 258, 53, textureX, textureY); // Box 415
		bodyModel[253] = new ModelRendererTurbo(this, 245, 53, textureX, textureY,"numberboard").setLightFixtureId("numberboard_body_253"); // Box 416 more sp numberboard
		...
		bodyModel[257] = new ModelRendererTurbo(this, 245, 49, textureX, textureY,"numberboard").setLightFixtureId("numberboard_body_257"); // Box 420 more sp numberboard
		...
		bodyModel[314] = new ModelRendererTurbo(this, 275, 134, textureX, textureY,"marker").setLightFixtureId("marker_crl_body_314"); // Box 422 crl markerlight
		bodyModel[315] = new ModelRendererTurbo(this, 275, 134, textureX, textureY,"marker").setLightFixtureId("marker_crl_body_315"); // Box 422 crl markerlight
		...
		bodyModel[370] = new ModelRendererTurbo(this, 275, 131, textureX, textureY,"marker").setLightFixtureId("marker_crl_body_370"); // Box 422 crl markerlight
		bodyModel[371] = new ModelRendererTurbo(this, 275, 131, textureX, textureY,"marker").setLightFixtureId("marker_crl_body_371"); // Box 422 crl markerlight
