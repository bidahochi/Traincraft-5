...
public class ModelSB23R extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[186] = new ModelRendererTurbo(this, 133, 68, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_186"); // Box 117 Numberboard
		bodyModel[187] = new ModelRendererTurbo(this, 133, 68, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_187"); // Box 118 Numberboard
		...
		bodyModel[197] = new ModelRendererTurbo(this, 171, 14, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_197"); // Box 117 Numberboard
		bodyModel[198] = new ModelRendererTurbo(this, 171, 14, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_198"); // Box 118 Numberboard
		...
		bodyModel[202] = new ModelRendererTurbo(this, 201, 167, textureX, textureY, "marker").setLightFixtureId("marker_body_202"); // Box 71 markerlight cull
		bodyModel[203] = new ModelRendererTurbo(this, 185, 189, textureX, textureY); // Box 235
		bodyModel[204] = new ModelRendererTurbo(this, 201, 167, textureX, textureY, "marker").setLightFixtureId("marker_body_204"); // Box 124 markerlight cull
		...
		bodyModel[241] = new ModelRendererTurbo(this, 17, 194, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_241"); // Box 71 glow speedometer
		bodyModel[242] = new ModelRendererTurbo(this, 17, 189, textureX, textureY); // Box 307 spedo
		bodyModel[243] = new ModelRendererTurbo(this, 55, 188, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_243"); // Box 275 cs speedo glow
		bodyModel[244] = new ModelRendererTurbo(this, 47, 59, textureX, textureY); // Box 334
		bodyModel[245] = new ModelRendererTurbo(this, 359, 91, textureX, textureY, "marker").setLightFixtureId("marker_body_245"); // Box 339 glowey marker
		bodyModel[246] = new ModelRendererTurbo(this, 359, 91, textureX, textureY, "marker").setLightFixtureId("marker_body_246"); // Box 340 glowey marker
		...
		bodyModel[271] = new ModelRendererTurbo(this, 346, 88, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_271"); // Box 117 Numberboard
		bodyModel[272] = new ModelRendererTurbo(this, 346, 88, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_272"); // Box 118 Numberboard
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (GetColor(entity) == 13244||GetColor(entity) == 3247) {
