...
public class ModelFAFDL extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[63] = new ModelRendererTurbo(this, 33, 60, textureX, textureY, "numberboard").setLightFixtureId("numberboard_left_body_63"); // Numberboard L type 2
		bodyModel[64] = new ModelRendererTurbo(this, 78, 71, textureX, textureY, "marker").setLightFixtureId("marker_l_type_2"); // Markerlight L type 2
		bodyModel[65] = new ModelRendererTurbo(this, 3, 71, textureX, textureY, "marker").setLightFixtureId("marker_r_type_2"); // Markerlight R type 2
		...
		bodyModel[80] = new ModelRendererTurbo(this, 33, 60, textureX, textureY, "numberboard").setLightFixtureId("rear_numberboard_right_body_80"); // Numberboard R type 2
		...
		bodyModel[182] = new ModelRendererTurbo(this, 472, 127, textureX, textureY, "marker").setLightFixtureId("marker_r_type_1"); // Markerlight R type 1
		...
		bodyModel[185] = new ModelRendererTurbo(this, 86, 127, textureX, textureY, "marker").setLightFixtureId("marker_l_type_1"); // Markerlight L type 1
		bodyModel[186] = new ModelRendererTurbo(this, 92, 126, textureX, textureY, "numberboard").setLightFixtureId("numberboard_left_body_186"); // Numberboard L type 1
		bodyModel[187] = new ModelRendererTurbo(this, 465, 126, textureX, textureY, "numberboard").setLightFixtureId("rear_numberboard_right_body_187"); // Numberboard R type 1
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (GetColor(entity) == 621 ||GetColor(entity) == 954) {
