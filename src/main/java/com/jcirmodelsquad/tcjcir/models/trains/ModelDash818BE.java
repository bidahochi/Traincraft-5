...
public class ModelDash818BE extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[180] = new ModelRendererTurbo(this, 148, 188, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_180"); // Box 275 cs speedo glow
		bodyModel[181] = new ModelRendererTurbo(this, 108, 185, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_181"); // Box 71 glow speedometer
		...
		bodyModel[184] = new ModelRendererTurbo(this, 143, 188, textureX, textureY, "instrument").setLightFixtureId("cab_signal_body_184"); // Box 412 cab signalling glowey
		...
		bodyModel[221] = new ModelRendererTurbo(this, 180, 121, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_221"); // Box 117 numberboard
		bodyModel[222] = new ModelRendererTurbo(this, 180, 121, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_222"); // Box 118 numberboard
		...
		bodyModel[226] = new ModelRendererTurbo(this, 119, 65, textureX, textureY, "marker").setLightFixtureId("marker_body_226"); // Box 301 markerlight glow
		bodyModel[227] = new ModelRendererTurbo(this, 119, 65, textureX, textureY, "marker").setLightFixtureId("marker_body_227"); // Box 344 markerlight glow
		...
		bodyModel[273] = new ModelRendererTurbo(this, 465, 27, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_273"); // Box 393 numberboard
		bodyModel[274] = new ModelRendererTurbo(this, 465, 27, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_274"); // Box 395 numberboard
		...
		bodyModel[282] = new ModelRendererTurbo(this, 497, 122, textureX, textureY, "marker").setLightFixtureId("marker_crl_body_282"); // Box 339 glow markerlight crl
		bodyModel[283] = new ModelRendererTurbo(this, 497, 122, textureX, textureY, "marker").setLightFixtureId("marker_crl_body_283"); // Box 345 glow markerlight crl
		bodyModel[284] = new ModelRendererTurbo(this, 504, 122, textureX, textureY, "marker").setLightFixtureId("marker_sou_body_284"); // Box 348 glow markerlight sou
		bodyModel[285] = new ModelRendererTurbo(this, 504, 122, textureX, textureY, "marker").setLightFixtureId("marker_sou_body_285"); // Box 349 sou markerlight glow
