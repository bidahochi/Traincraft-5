...
public class ModelLNCoach2551Series extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[256] = new ModelRendererTurbo(this, 120, 230, textureX, textureY,"interior").setLightFixtureId("interior_body_256"); // Box 275 glow
		bodyModel[257] = new ModelRendererTurbo(this, 120, 220, textureX, textureY,"interior").setLightFixtureId("interior_body_257"); // Box 285 glow
		...
		bodyModel[260] = new ModelRendererTurbo(this, 158, 207, textureX, textureY,"interior").setLightFixtureId("interior_body_260"); // Box 38 glow
		bodyModel[261] = new ModelRendererTurbo(this, 167, 207, textureX, textureY,"interior").setLightFixtureId("interior_body_261"); // Box 38 glow
		bodyModel[262] = new ModelRendererTurbo(this, 176, 207, textureX, textureY,"interior").setLightFixtureId("interior_body_262"); // Box 38 glow
		bodyModel[263] = new ModelRendererTurbo(this, 185, 207, textureX, textureY,"interior").setLightFixtureId("interior_body_263"); // Box 38 glow
		bodyModel[264] = new ModelRendererTurbo(this, 194, 207, textureX, textureY,"interior").setLightFixtureId("interior_body_264"); // Box 38 glow
		bodyModel[265] = new ModelRendererTurbo(this, 203, 207, textureX, textureY,"interior").setLightFixtureId("interior_body_265"); // Box 38 glow
		...
		bodyModel[290] = new ModelRendererTurbo(this, 379, 43, textureX, textureY,"interior").setLightFixtureId("interior_body_290"); // Box 128 glow
		...
		bodyModel[345] = new ModelRendererTurbo(this, 394, 41, textureX, textureY,"interior").setLightFixtureId("interior_body_345"); // Box 128 glow
		bodyModel[346] = new ModelRendererTurbo(this, 211, 208, textureX, textureY,"interior").setLightFixtureId("interior_body_346"); // Box 128 glow
		bodyModel[347] = new ModelRendererTurbo(this, 154, 208, textureX, textureY,"interior").setLightFixtureId("interior_body_347"); // Box 128 glow
		bodyModel[348] = new ModelRendererTurbo(this, 135, 208, textureX, textureY,"interior").setLightFixtureId("interior_body_348"); // Box 128 glow
		bodyModel[349] = new ModelRendererTurbo(this, 214, 208, textureX, textureY,"interior").setLightFixtureId("interior_body_349"); // Box 128 glow
