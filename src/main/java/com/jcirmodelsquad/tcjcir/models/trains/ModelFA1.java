...
public class ModelFA1 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[105] = new ModelRendererTurbo(this, 66, 60, textureX, textureY,"numberboard").setLightFixtureId("numberboard_left_body_105"); // Numberboard L type 2
		bodyModel[106] = new ModelRendererTurbo(this, 78, 71, textureX, textureY,"marker").setLightFixtureId("marker_l_type_2"); // Markerlight L type 2
		bodyModel[107] = new ModelRendererTurbo(this, 3, 71, textureX, textureY,"marker").setLightFixtureId("marker_r_type_2"); // Markerlight R type 2
		...
		bodyModel[145] = new ModelRendererTurbo(this, 8, 60, textureX, textureY,"numberboard").setLightFixtureId("rear_numberboard_right_body_145"); // Numberboard R type 2
		...
		bodyModel[380] = new ModelRendererTurbo(this, 472, 127, textureX, textureY,"marker").setLightFixtureId("marker_r_type_1"); // Markerlight R type 1
		...
		bodyModel[383] = new ModelRendererTurbo(this, 86, 127, textureX, textureY,"marker").setLightFixtureId("marker_l_type_1"); // Markerlight L type 1
		bodyModel[384] = new ModelRendererTurbo(this, 92, 126, textureX, textureY,"numberboard").setLightFixtureId("numberboard_left_body_384"); // Numberboard L type 1
		bodyModel[385] = new ModelRendererTurbo(this, 465, 126, textureX, textureY,"numberboard").setLightFixtureId("rear_numberboard_right_body_385"); // Numberboard R type 1
		bodyModel[386] = new ModelRendererTurbo(this, 78, 15, textureX, textureY); // Box 0
		bodyModel[387] = new ModelRendererTurbo(this, 73, 12, textureX, textureY,"numberboard").setLightFixtureId("numberboard_body_387"); // Numberboard type 5
