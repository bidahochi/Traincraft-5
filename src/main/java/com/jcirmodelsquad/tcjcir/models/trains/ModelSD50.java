...
public class ModelSD50 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[114] = new ModelRendererTurbo(this, 1, 40, textureX, textureY, "marker").setLightFixtureId("front_marker"); // Box 71 markerlight front
		bodyModel[115] = new ModelRendererTurbo(this, 1, 40, textureX, textureY, "lamp").setLightFixtureId("front_marker2"); // Box 1208 makrerlight front
		...
		bodyModel[147] = new ModelRendererTurbo(this, 133, 90, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_body_147"); // Box 117 numberboard front
		bodyModel[148] = new ModelRendererTurbo(this, 133, 90, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_body_148"); // Box 118 numberboard front
		...
		bodyModel[166] = new ModelRendererTurbo(this, 476, 75, textureX, textureY, "numberboard").setLightFixtureId("rear_numberboard_body_166"); // Box 115 numberboard rear
		bodyModel[167] = new ModelRendererTurbo(this, 476, 75, textureX, textureY, "numberboard").setLightFixtureId("rear_numberboard_body_167"); // Box 116 numberboard rear
		bodyModel[168] = new ModelRendererTurbo(this, 454, 89, textureX, textureY, "marker").setLightFixtureId("rear_marker_low"); // Box 71 markerlight rear low
		bodyModel[169] = new ModelRendererTurbo(this, 454, 89, textureX, textureY, "lamp").setLightFixtureId("rear_marker_low2"); // Box 1208 makrerlight rear low
		bodyModel[170] = new ModelRendererTurbo(this, 460, 84, textureX, textureY, "marker").setLightFixtureId("rear_marker_high"); // Box 71 markerlight rear high
		bodyModel[171] = new ModelRendererTurbo(this, 460, 84, textureX, textureY, "marker").setLightFixtureId("rear_marker_high2"); // Box 1208 makrerlight rear high
		...
		bodyModel[235] = new ModelRendererTurbo(this, 183, 43, textureX, textureY, "lamp").setLightFixtureId("frontHighbeamF"); // Box 338 lamp
		bodyModel[236] = new ModelRendererTurbo(this, 173, 43, textureX, textureY, "lamp").setLightFixtureId("frontHighbeamE"); // Box 337 lamp
		...
		bodyModel[302] = new ModelRendererTurbo(this, 82, 151, textureX, textureY, BoxName.ditch).setLightFixtureId("FrontDitchLow1"); // Box 273 lamp ditchlight front
		bodyModel[303] = new ModelRendererTurbo(this, 82, 151, textureX, textureY, BoxName.ditch).setLightFixtureId("FrontDitchLow2"); // Box 274 lamp ditchlight front
		...
		bodyModel[306] = new ModelRendererTurbo(this, 441, 179, textureX, textureY, BoxName.ditch).setLightFixtureId("RearDitchLow1"); // Box 273 lamp ditchlight front
		bodyModel[307] = new ModelRendererTurbo(this, 441, 179, textureX, textureY, BoxName.ditch).setLightFixtureId("RearDitchLow2"); // Box 274 lamp ditchlight front
		...
		bodyModel[310] = new ModelRendererTurbo(this, 19, 170, textureX, textureY, BoxName.ditch).setLightFixtureId("FrontDitch1"); // Box 578 THIS IS A DITCHLIGHT IT WILL GLOWE
		bodyModel[311] = new ModelRendererTurbo(this, 19, 170, textureX, textureY, BoxName.ditch).setLightFixtureId("FrontDitch2"); // Box 579THIS IS A DITCHLUIGHT IT WILL GLOW
		...
		bodyModel[345] = new ModelRendererTurbo(this, 36, 56, textureX, textureY, "marker").setLightFixtureId("front_marker_bugeye_body_345"); // Box 364 markerlight bugeye front
		bodyModel[346] = new ModelRendererTurbo(this, 36, 56, textureX, textureY, "marker").setLightFixtureId("front_marker_bugeye_body_346"); // Box 364 markerlight bugeye front
		bodyModel[347] = new ModelRendererTurbo(this, 484, 77, textureX, textureY, "marker").setLightFixtureId("rear_marker_bugeye_body_347"); // Box 364 markerlight bugeye rear
		bodyModel[348] = new ModelRendererTurbo(this, 484, 77, textureX, textureY, "marker").setLightFixtureId("rear_marker_bugeye_body_348"); // Box 364 markerlight bugeye rear
		...
		bodyModel[353] = new ModelRendererTurbo(this, 415, 179, textureX, textureY, BoxName.ditch).setLightFixtureId("RearDitch1"); // Box 580THIS IS A DITCHLIGHT IT WILL GLOW
		bodyModel[354] = new ModelRendererTurbo(this, 417, 174, textureX, textureY, BoxName.ditch).setLightFixtureId("RearDitch2"); // Box 581YARR AHOY MATEY THIS BE ERE A DITCHLIGHT AND THAR SHE SHALL GLOWETH
		...
		bodyModel[383] = new ModelRendererTurbo(this, 108, 185, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_383"); // Box 71 glow speedometer
		...
		bodyModel[477] = new ModelRendererTurbo(this, 39, 157, textureX, textureY, BoxName.ditch).setLightFixtureId("FrontDitchHigh1"); // Box 412 ditchlight ane f
		bodyModel[478] = new ModelRendererTurbo(this, 39, 157, textureX, textureY, BoxName.ditch).setLightFixtureId("FrontDitchHigh2"); // Box 412  ditchlight ane f
		...
		bodyModel[481] = new ModelRendererTurbo(this, 377, 174, textureX, textureY, BoxName.ditch).setLightFixtureId("RearDitchHigh1"); // Box 417 ditchlight ane r
		bodyModel[482] = new ModelRendererTurbo(this, 377, 174, textureX, textureY, BoxName.ditch).setLightFixtureId("RearDitchHigh2"); // Box 416 ditchlight ane r
