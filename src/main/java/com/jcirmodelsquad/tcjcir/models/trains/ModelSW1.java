...
public class ModelSW1 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[196] = new ModelRendererTurbo(this, 294, 133, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_196"); // Box 626 sp numberboard
		bodyModel[197] = new ModelRendererTurbo(this, 294, 147, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_197"); // Box 625 sp numerbboard
		...
		bodyModel[202] = new ModelRendererTurbo(this, 154, 152, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_body_202"); // Box 386 numberboard front 2beam
		bodyModel[203] = new ModelRendererTurbo(this, 161, 152, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_body_203"); // Box 385 numberboard front 2beam
		...
		bodyModel[208] = new ModelRendererTurbo(this, 161, 150, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_single_body_208"); // Box 168 numberboard front single
		bodyModel[209] = new ModelRendererTurbo(this, 161, 148, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_single_body_209"); // Box 167 numberboard front single
		...
		bodyModel[215] = new ModelRendererTurbo(this, 168, 148, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_body_215"); // Box 386 numberboard front 2beam
		bodyModel[216] = new ModelRendererTurbo(this, 175, 148, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_body_216"); // Box 385 numberboard front 2beam
		...
		bodyModel[221] = new ModelRendererTurbo(this, 142, 152, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_single_body_221"); // Box 168 numberboard front single
		bodyModel[222] = new ModelRendererTurbo(this, 147, 152, textureX, textureY, "numberboard").setLightFixtureId("front_numberboard_single_body_222"); // Box 167 numberboard front single
