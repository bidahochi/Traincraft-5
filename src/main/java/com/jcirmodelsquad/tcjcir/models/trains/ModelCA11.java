...
public class ModelCA11 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[213] = new ModelRendererTurbo(this, 461, 2, textureX, textureY, "lamp").setLightFixtureId("rear_center"); // Box 426 light rear
		bodyModel[214] = new ModelRendererTurbo(this, 461, 2, textureX, textureY, "lamp").setLightFixtureId("front_center"); // Box 250 light front
		...
		bodyModel[220] = new ModelRendererTurbo(this, 374, 119, textureX, textureY, "prime1").setLightFixtureId("prime_1"); // Box 6 PRIME4-1
		bodyModel[221] = new ModelRendererTurbo(this, 374, 119, textureX, textureY, "prime3").setLightFixtureId("prime_3"); // Box 7 PRIME4-3
		bodyModel[222] = new ModelRendererTurbo(this, 374, 119, textureX, textureY, "prime2").setLightFixtureId("prime_2"); // Box 8 PRIME4-2
		bodyModel[223] = new ModelRendererTurbo(this, 374, 119, textureX, textureY, "prime4").setLightFixtureId("prime_4"); // Box 9 PRIME4-4
		...
		bodyModel[229] = new ModelRendererTurbo(this, 91, 66, textureX, textureY, "lamp").setLightFixtureId("front_right"); // Box 411 front light R
		bodyModel[230] = new ModelRendererTurbo(this, 86, 69, textureX, textureY, "lamp").setLightFixtureId("front_left"); // Box 412 front light L
		bodyModel[231] = new ModelRendererTurbo(this, 86, 69, textureX, textureY, "lamp").setLightFixtureId("rear_left"); // Box 257 rear light l
		bodyModel[232] = new ModelRendererTurbo(this, 91, 66, textureX, textureY, "lamp").setLightFixtureId("rear_right"); // Box 257 real light r
		...
		bodyModel[238] = new ModelRendererTurbo(this, 63, 55, textureX, textureY, "lamp").setLightFixtureId("front_headlight_upper"); // Box 247 Headlight Front
		bodyModel[239] = new ModelRendererTurbo(this, 77, 55, textureX, textureY, "lamp").setLightFixtureId("front_headlight_lower"); // Box 248 Headlight Front
		bodyModel[240] = new ModelRendererTurbo(this, 98, 54, textureX, textureY); // Box 296
		bodyModel[241] = new ModelRendererTurbo(this, 70, 55, textureX, textureY, "lamp").setLightFixtureId("left_side_upper"); // Box 264 glow
		bodyModel[242] = new ModelRendererTurbo(this, 91, 54, textureX, textureY); // Box 263
		bodyModel[243] = new ModelRendererTurbo(this, 84, 55, textureX, textureY, "lamp").setLightFixtureId("left_side_lower"); // Box 264 glow
