...
public class ModelM63X_divets extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[79] = new ModelRendererTurbo(this, 0, 62, textureX, textureY, "front_headlight_n_upper"); // Box 448 headlight front n
		bodyModel[80] = new ModelRendererTurbo(this, 0, 67, textureX, textureY, "front_headlight_n_lower"); // Box 449 headlight front n
		bodyModel[81] = new ModelRendererTurbo(this, 0, 82, textureX, textureY, "front_headlight_rock_right"); // Box 451 headlight front rock
		bodyModel[82] = new ModelRendererTurbo(this, 7, 82, textureX, textureY, "front_headlight_rock_left"); // Box 454 headlight front rock
		...
		bodyModel[103] = new ModelRendererTurbo(this, 26, 11, textureX, textureY, "numberboard"); // Box 117 numberboard f
		...
		bodyModel[107] = new ModelRendererTurbo(this, 22, 11, textureX, textureY, "front_classlight_right"); // Box 216 classlights
		...
		bodyModel[116] = new ModelRendererTurbo(this, 41, 11, textureX, textureY, "numberboard"); // Box 197 numberboard f
		...
		bodyModel[119] = new ModelRendererTurbo(this, 49, 11, textureX, textureY, "front_classlight_left"); // Box 217 classlights
		...
		bodyModel[141] = new ModelRendererTurbo(this, 477, 12, textureX, textureY, "rear_headlight_lower"); // Box 162 headlight r
		bodyModel[142] = new ModelRendererTurbo(this, 477, 5, textureX, textureY, "rear_headlight_upper"); // Box 163 headlight r
		bodyModel[143] = new ModelRendererTurbo(this, 468, 25, textureX, textureY); // Box 1523
		bodyModel[144] = new ModelRendererTurbo(this, 471, 30, textureX, textureY, "rear_marker_right"); // Box 1526 markerlight
		bodyModel[145] = new ModelRendererTurbo(this, 503, 31, textureX, textureY, "rear_marker_left"); // Box 1527 markerlight
		bodyModel[146] = new ModelRendererTurbo(this, 462, 2, textureX, textureY, "numberboard"); // Box 302 numberboard
		bodyModel[147] = new ModelRendererTurbo(this, 462, 2, textureX, textureY, "numberboard"); // Box 303 numberboard
		...
		bodyModel[299] = new ModelRendererTurbo(this, 12, 62, textureX, textureY, "front_headlight_high_right"); // Box 449 front headlight N
		bodyModel[300] = new ModelRendererTurbo(this, 22, 63, textureX, textureY); // Box 74
		bodyModel[301] = new ModelRendererTurbo(this, 19, 62, textureX, textureY, "front_headlight_high_left"); // Box 448 front headlight N
		...
		bodyModel[312] = new ModelRendererTurbo(this, 48, 62, textureX, textureY, "front_gyralite_right"); // Box 449 FCP gyra light
		bodyModel[313] = new ModelRendererTurbo(this, 34, 63, textureX, textureY); // Box 74 gyra light socket
		bodyModel[314] = new ModelRendererTurbo(this, 41, 62, textureX, textureY, "front_gyralite_left"); // Box 448 FCP gyra light
		...
		bodyModel[317] = new ModelRendererTurbo(this, 1, 23, textureX, textureY, "front_headlight_vertical_upper"); // Box 87 headlight front vertical
		bodyModel[318] = new ModelRendererTurbo(this, 1, 28, textureX, textureY, "front_headlight_vertical_lower"); // Box 88 headlight front vertical
