...
public class ModelPS85Baggage extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[159] = new ModelRendererTurbo(this, 88, 195, textureX, textureY, "interior").setLightFixtureId("interior_body_159"); // Box 38 glow
		...
		bodyModel[162] = new ModelRendererTurbo(this, 88, 224, textureX, textureY, "interior").setLightFixtureId("interior_body_162"); // Box 38 glow
		...
		bodyModel[165] = new ModelRendererTurbo(this, 117, 195, textureX, textureY, "interior").setLightFixtureId("interior_body_165"); // Box 38 glow
		...
		bodyModel[168] = new ModelRendererTurbo(this, 117, 224, textureX, textureY, "interior").setLightFixtureId("interior_body_168"); // Box 38 glow
		...
		bodyModel[188] = new ModelRendererTurbo(this, 94, 211, textureX, textureY, "interior").setLightFixtureId("interior_body_188"); // Box 38 glow
		bodyModel[189] = new ModelRendererTurbo(this, 85, 211, textureX, textureY, "interior").setLightFixtureId("interior_body_189"); // Box 38 glow
		bodyModel[190] = new ModelRendererTurbo(this, 44, 208, textureX, textureY, "interior").setLightFixtureId("interior_body_190"); // Box 38 glow
		bodyModel[191] = new ModelRendererTurbo(this, 17, 208, textureX, textureY, "interior").setLightFixtureId("interior_body_191"); // Box 38 glow
		bodyModel[192] = new ModelRendererTurbo(this, 1, 208, textureX, textureY, "interior").setLightFixtureId("interior_body_192"); // Box 38 glow
		bodyModel[193] = new ModelRendererTurbo(this, 130, 208, textureX, textureY); // Box 38
		bodyModel[194] = new ModelRendererTurbo(this, 112, 211, textureX, textureY, "interior").setLightFixtureId("interior_body_194"); // Box 38 glow
		bodyModel[195] = new ModelRendererTurbo(this, 103, 211, textureX, textureY, "interior").setLightFixtureId("interior_body_195"); // Box 38 glow
		bodyModel[196] = new ModelRendererTurbo(this, 191, 209, textureX, textureY, "interior").setLightFixtureId("interior_body_196"); // Box 38 glow
		bodyModel[197] = new ModelRendererTurbo(this, 174, 209, textureX, textureY, "interior").setLightFixtureId("interior_body_197"); // Box 38 glow
		bodyModel[198] = new ModelRendererTurbo(this, 157, 209, textureX, textureY, "interior").setLightFixtureId("interior_body_198"); // Box 38 glow
		bodyModel[199] = new ModelRendererTurbo(this, 121, 211, textureX, textureY, "interior").setLightFixtureId("interior_body_199"); // Box 38 glow
