...
public class ModelF9a_new extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[117] = new ModelRendererTurbo(this, 8, 174, textureX, textureY, "lamp").setLightFixtureId("HL_U1A"); // Box 186 headlight 2beam top A
		bodyModel[118] = new ModelRendererTurbo(this, 8, 179, textureX, textureY, "lamp").setLightFixtureId("HL_U1B"); // Box 187 headlight 2beam top A
		...
		bodyModel[124] = new ModelRendererTurbo(this, 13, 139, textureX, textureY, "lamp").setLightFixtureId("HL_L1A"); // Box 186 headlight 2beam bottom A
		bodyModel[125] = new ModelRendererTurbo(this, 13, 144, textureX, textureY, "lamp").setLightFixtureId("HL_L1B"); // Box 187 headlight 2beam bottom A
		bodyModel[126] = new ModelRendererTurbo(this, 12, 149, textureX, textureY, "lamp"); // Box 169 headlight big bottom
		bodyModel[127] = new ModelRendererTurbo(this, 30, 151, textureX, textureY, "lamp").setLightFixtureId("HL_L2A"); // Box 186 headlight 2beam bottom B
		bodyModel[128] = new ModelRendererTurbo(this, 21, 151, textureX, textureY, "lamp").setLightFixtureId("HL_L2B"); // Box 187 headlight 2beam bottom B
		bodyModel[129] = new ModelRendererTurbo(this, 23, 186, textureX, textureY, "lamp").setLightFixtureId("HL_U2A"); // Box 186 headlight 2beam top B
		bodyModel[130] = new ModelRendererTurbo(this, 16, 186, textureX, textureY, "lamp").setLightFixtureId("HL_U2B"); // Box 187 headlight 2beam top B
		...
		bodyModel[212] = new ModelRendererTurbo(this, 199, -2, textureX, textureY, "instrument").setLightFixtureId("cab_gauge_body_212"); // Box 475 cs1 gaugepannel hd
		bodyModel[213] = new ModelRendererTurbo(this, 204, 16, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_213"); // Box 591 speedoooo glowe
		...
		bodyModel[267] = new ModelRendererTurbo(this, 117, 113, textureX, textureY, "marker").setLightFixtureId("marker_early_body_267"); // Box 123 Markerlight Early
		bodyModel[268] = new ModelRendererTurbo(this, 122, 113, textureX, textureY, "numberboard").setLightFixtureId("numberboard_early_body_268"); // Box 144 numberboard early
		bodyModel[269] = new ModelRendererTurbo(this, 122, 113, textureX, textureY, "numberboard").setLightFixtureId("numberboard_early_body_269"); // Box 111 numberboard early
		bodyModel[270] = new ModelRendererTurbo(this, 117, 113, textureX, textureY, "marker").setLightFixtureId("marker_early_body_270"); // Box 453 Markerlight Early
		bodyModel[271] = new ModelRendererTurbo(this, 99, 122, textureX, textureY); // Box 468
		bodyModel[272] = new ModelRendererTurbo(this, 108, 118, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_272"); // Box 469 numberboard
		bodyModel[273] = new ModelRendererTurbo(this, 112, 115, textureX, textureY, "marker").setLightFixtureId("marker_body_273"); // Box 470 markerlight
		...
		bodyModel[280] = new ModelRendererTurbo(this, 108, 118, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_280"); // Box 824 numberboard
		bodyModel[281] = new ModelRendererTurbo(this, 112, 115, textureX, textureY, "marker").setLightFixtureId("marker_body_281"); // Box 825 markerlight
