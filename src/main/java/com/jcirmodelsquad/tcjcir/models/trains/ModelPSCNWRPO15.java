...
public class ModelPSCNWRPO15 extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[276] = new ModelRendererTurbo(this, 78, 228, textureX, textureY,"interior").setLightFixtureId("interior_body_276"); // Box 38 glow
		bodyModel[277] = new ModelRendererTurbo(this, 80, 224, textureX, textureY); // Box 426
		bodyModel[278] = new ModelRendererTurbo(this, 78, 208, textureX, textureY,"interior").setLightFixtureId("interior_body_278"); // Box 38 glow
		bodyModel[279] = new ModelRendererTurbo(this, 80, 204, textureX, textureY); // Box 460
		bodyModel[280] = new ModelRendererTurbo(this, 78, 217, textureX, textureY,"interior").setLightFixtureId("interior_body_280"); // Box 38 glow
		bodyModel[281] = new ModelRendererTurbo(this, 54, 217, textureX, textureY,"interior").setLightFixtureId("interior_body_281"); // Box 38 glow
		bodyModel[282] = new ModelRendererTurbo(this, 45, 217, textureX, textureY,"interior").setLightFixtureId("interior_body_282"); // Box 38 glow
		...
		bodyModel[286] = new ModelRendererTurbo(this, 32, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_286"); // Box 38 glow
		bodyModel[287] = new ModelRendererTurbo(this, 23, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_287"); // Box 38 glow
		...
		bodyModel[290] = new ModelRendererTurbo(this, 40, 233, textureX, textureY,"interior").setLightFixtureId("interior_body_290"); // Box 38 glow
		...
		bodyModel[293] = new ModelRendererTurbo(this, 40, 192, textureX, textureY,"interior").setLightFixtureId("interior_body_293"); // Box 38 glow
		...
		bodyModel[334] = new ModelRendererTurbo(this, 178, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_334"); // Box 38 glow
		bodyModel[335] = new ModelRendererTurbo(this, 169, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_335"); // Box 38 glow
		bodyModel[336] = new ModelRendererTurbo(this, 205, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_336"); // Box 38 glow
		bodyModel[337] = new ModelRendererTurbo(this, 187, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_337"); // Box 38 glow
		bodyModel[338] = new ModelRendererTurbo(this, 223, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_338"); // Box 38 glow
		bodyModel[339] = new ModelRendererTurbo(this, 214, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_339"); // Box 38 glow
		bodyModel[340] = new ModelRendererTurbo(this, 249, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_340"); // Box 38 glow
		bodyModel[341] = new ModelRendererTurbo(this, 267, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_341"); // Box 38 glow
		bodyModel[342] = new ModelRendererTurbo(this, 258, 210, textureX, textureY,"interior").setLightFixtureId("interior_body_342"); // Box 38 glow
		...
		bodyModel[414] = new ModelRendererTurbo(this, 235, 219, textureX, textureY,"interior").setLightFixtureId("interior_body_414"); // Box 38 glow
		bodyModel[415] = new ModelRendererTurbo(this, 235, 189, textureX, textureY,"interior").setLightFixtureId("interior_body_415"); // Box 429 glow
		bodyModel[416] = new ModelRendererTurbo(this, 288, 218, textureX, textureY,"interior").setLightFixtureId("interior_body_416"); // Box 38 glow
		bodyModel[417] = new ModelRendererTurbo(this, 288, 190, textureX, textureY,"interior").setLightFixtureId("interior_body_417"); // Box 429 glow
