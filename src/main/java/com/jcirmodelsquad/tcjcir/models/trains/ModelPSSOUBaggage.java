...
public class ModelPSSOUBaggage extends ModelConverter//Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[137] = new ModelRendererTurbo(this, 290, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_137"); // Box 38 glow
		...
		bodyModel[140] = new ModelRendererTurbo(this, 162, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_140"); // Box 38 glow
		bodyModel[141] = new ModelRendererTurbo(this, 192, 191, textureX, textureY,"interior").setLightFixtureId("interior_body_141"); // Box 38 glow
		bodyModel[142] = new ModelRendererTurbo(this, 183, 191, textureX, textureY,"interior").setLightFixtureId("interior_body_142"); // Box 38 glow
		bodyModel[143] = new ModelRendererTurbo(this, 228, 191, textureX, textureY,"interior").setLightFixtureId("interior_body_143"); // Box 38 glow
		bodyModel[144] = new ModelRendererTurbo(this, 255, 191, textureX, textureY,"interior").setLightFixtureId("interior_body_144"); // Box 38 glow
		bodyModel[145] = new ModelRendererTurbo(this, 246, 191, textureX, textureY,"interior").setLightFixtureId("interior_body_145"); // Box 38 glow
		bodyModel[146] = new ModelRendererTurbo(this, 237, 191, textureX, textureY,"interior").setLightFixtureId("interior_body_146"); // Box 38 glow
		bodyModel[147] = new ModelRendererTurbo(this, 219, 191, textureX, textureY,"interior").setLightFixtureId("interior_body_147"); // Box 38 glow
		bodyModel[148] = new ModelRendererTurbo(this, 210, 191, textureX, textureY,"interior").setLightFixtureId("interior_body_148"); // Box 38 glow
		...
		bodyModel[302] = new ModelRendererTurbo(this, 80, 211, textureX, textureY,"interior").setLightFixtureId("interior_body_302"); // Box 38 glow
		bodyModel[303] = new ModelRendererTurbo(this, 201, 191, textureX, textureY,"interior").setLightFixtureId("interior_body_303"); // Box 38 glow
