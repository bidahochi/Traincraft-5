...
public class ModelC415L extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[72] = new ModelRendererTurbo(this, 25, 138, textureX, textureY, "marker").setLightFixtureId("marker_body_72"); // Box 1521 markerlight
		bodyModel[73] = new ModelRendererTurbo(this, 25, 138, textureX, textureY, "marker").setLightFixtureId("marker_body_73"); // Box 1522 markerlight
		bodyModel[74] = new ModelRendererTurbo(this, 239, 133, textureX, textureY); // Box 1523
		bodyModel[75] = new ModelRendererTurbo(this, 252, 138, textureX, textureY, "marker").setLightFixtureId("marker_body_75"); // Box 1526 markerlight
		bodyModel[76] = new ModelRendererTurbo(this, 252, 138, textureX, textureY, "marker").setLightFixtureId("marker_body_76"); // Box 1527 markerlight
		...
		bodyModel[219] = new ModelRendererTurbo(this, 11, 130, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_219"); // Box 302 numberboard
		bodyModel[220] = new ModelRendererTurbo(this, 11, 130, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_220"); // Box 303 numberboard
		...
		bodyModel[224] = new ModelRendererTurbo(this, 256, 130, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_224"); // Box 302 numberboard
		bodyModel[225] = new ModelRendererTurbo(this, 256, 130, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_225"); // Box 303 numberboard
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (GetColor(entity) == 135461 || GetColor(entity) == 7234 || GetColor(entity) == 8546 || GetColor(entity) == 5546) {
			...
			typeB2.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 0 || GetColor(entity) == 5462) {
