...
public class ModelB_BEL extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[86] = new ModelRendererTurbo(this, 1, 65, textureX, textureY, "marker_body_86"); // Box 307 glowey marker
		bodyModel[87] = new ModelRendererTurbo(this, 1, 65, textureX, textureY, "marker_body_87"); // Box 308 glowey marker
		...
		bodyModel[130] = new ModelRendererTurbo(this, 1, 47, textureX, textureY, "lamp_up"); // Box 186 Headlight Front up
		bodyModel[131] = new ModelRendererTurbo(this, 1, 52, textureX, textureY, "lamp_down"); // Box 187 Headlight Front down
		bodyModel[132] = new ModelRendererTurbo(this, 39, 54, textureX, textureY, "numberboard"); // Box 117 numberboard
		bodyModel[133] = new ModelRendererTurbo(this, 39, 54, textureX, textureY, "numberboard"); // Box 118 numberboard
		...
		bodyModel[161] = new ModelRendererTurbo(this, 481, 109, textureX, textureY, "numberboard"); // Box 165 numberboard early
		bodyModel[162] = new ModelRendererTurbo(this, 481, 109, textureX, textureY, "numberboard"); // Box 167 numberboard early
		...
		bodyModel[172] = new ModelRendererTurbo(this, 499, 91, textureX, textureY, "numberboard"); // Box 215 numberboard late
		bodyModel[173] = new ModelRendererTurbo(this, 499, 91, textureX, textureY, "numberboard"); // Box 216 numberboard late
		...
		bodyModel[176] = new ModelRendererTurbo(this, 499, 140, textureX, textureY, "marker_body_176"); // Box 339 glowey marker
		bodyModel[177] = new ModelRendererTurbo(this, 499, 140, textureX, textureY, "marker_body_177"); // Box 340 glowey marker
		...
		bodyModel[265] = new ModelRendererTurbo(this, 201, 60, textureX, textureY, "ditchf1b"); // Box 190 ditchlight f1
		bodyModel[266] = new ModelRendererTurbo(this, 201, 60, textureX, textureY, "ditchf1a"); // Box 446 ditchlight f1
		...
		bodyModel[269] = new ModelRendererTurbo(this, 213, 60, textureX, textureY, "ditchr1a"); // Box 276 ditchlight r1
		bodyModel[270] = new ModelRendererTurbo(this, 213, 65, textureX, textureY); // Box 442
		bodyModel[271] = new ModelRendererTurbo(this, 213, 60, textureX, textureY, "ditchr1b"); // Box 443 ditchlight r1
		...
		bodyModel[304] = new ModelRendererTurbo(this, 55, 188, textureX, textureY, "cab_speedometer_body_304"); // Box 275 cs speedo glow
		...
		bodyModel[310] = new ModelRendererTurbo(this, 492, 140, textureX, textureY, "marker_2_body_310"); // Box 339 glowey marker 2
		bodyModel[311] = new ModelRendererTurbo(this, 492, 140, textureX, textureY, "marker_2_body_311"); // Box 340 glowey marker 2
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		if (GetColor(entity) == 43231||GetColor(entity) == 320
				||GetColor(entity) == 343) {
			//fb2 black late
			...
			theTrucks4.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 7||GetColor(entity) == 9){
			//fb2 blac early
			Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, "textures/trains/newBogies/fb2_new_black_a.png"));
			GL11.glPushMatrix();
			GL11.glTranslated(-1.54, -0.015, 0);
			...
			theTrucks2.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 8||GetColor(entity) == 5
				||GetColor(entity) == 11){
			//type b black early
