...
public class ModelB_BEL extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[86] = new ModelRendererTurbo(this, 1, 65, textureX, textureY, "marker").setLightFixtureId("marker_body_86"); // Box 307 glowey marker
		bodyModel[87] = new ModelRendererTurbo(this, 1, 65, textureX, textureY, "marker").setLightFixtureId("marker_body_87"); // Box 308 glowey marker
		...
		bodyModel[132] = new ModelRendererTurbo(this, 39, 54, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_132"); // Box 117 numberboard
		bodyModel[133] = new ModelRendererTurbo(this, 39, 54, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_133"); // Box 118 numberboard
		...
		bodyModel[161] = new ModelRendererTurbo(this, 481, 109, textureX, textureY, "numberboard").setLightFixtureId("numberboard_early_body_161"); // Box 165 numberboard early
		bodyModel[162] = new ModelRendererTurbo(this, 481, 109, textureX, textureY, "numberboard").setLightFixtureId("numberboard_early_body_162"); // Box 167 numberboard early
		...
		bodyModel[172] = new ModelRendererTurbo(this, 499, 91, textureX, textureY, "numberboard").setLightFixtureId("numberboard_late_body_172"); // Box 215 numberboard late
		bodyModel[173] = new ModelRendererTurbo(this, 499, 91, textureX, textureY, "numberboard").setLightFixtureId("numberboard_late_body_173"); // Box 216 numberboard late
		...
		bodyModel[176] = new ModelRendererTurbo(this, 499, 140, textureX, textureY, "marker").setLightFixtureId("marker_body_176"); // Box 339 glowey marker
		bodyModel[177] = new ModelRendererTurbo(this, 499, 140, textureX, textureY, "marker").setLightFixtureId("marker_body_177"); // Box 340 glowey marker
		...
		bodyModel[304] = new ModelRendererTurbo(this, 55, 188, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_304"); // Box 275 cs speedo glow
		...
		bodyModel[310] = new ModelRendererTurbo(this, 492, 140, textureX, textureY, "marker").setLightFixtureId("marker_2_body_310"); // Box 339 glowey marker 2
		bodyModel[311] = new ModelRendererTurbo(this, 492, 140, textureX, textureY, "marker").setLightFixtureId("marker_2_body_311"); // Box 340 glowey marker 2
