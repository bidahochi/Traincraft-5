...
public class ModelDash840BB extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[142] = new ModelRendererTurbo(this, 119, 107, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_142"); // Box 393 numberboard
		bodyModel[143] = new ModelRendererTurbo(this, 381, 127, textureX, textureY); // Box 394
		bodyModel[144] = new ModelRendererTurbo(this, 119, 107, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_144"); // Box 395 numberboard
		bodyModel[145] = new ModelRendererTurbo(this, 107, 132, textureX, textureY, "marker").setLightFixtureId("marker_body_145"); // Box 398 glow marker
		bodyModel[146] = new ModelRendererTurbo(this, 107, 132, textureX, textureY, "marker").setLightFixtureId("marker_body_146"); // Box 399 glow marker
		...
		bodyModel[198] = new ModelRendererTurbo(this, 119, 107, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_198"); // Box 305 numberboard
		bodyModel[199] = new ModelRendererTurbo(this, 119, 107, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_199"); // Box 306 numberboard
		bodyModel[200] = new ModelRendererTurbo(this, 107, 132, textureX, textureY, "marker").setLightFixtureId("marker_body_200"); // Box 307 glow marker
		bodyModel[201] = new ModelRendererTurbo(this, 107, 132, textureX, textureY, "marker").setLightFixtureId("marker_body_201"); // Box 308 glow marker
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
		...
		if (GetColor(entity) == 14321){
			...
			theTrucks2.render(entity, f, f1, f2, f3, f4, f5);
			GL11.glPopMatrix();
		} else if (GetColor(entity) == 1||GetColor(entity) == 17){
