...
public class ModelU30C_new extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[93] = new ModelRendererTurbo(this, 1, 65, textureX, textureY, "marker").setLightFixtureId("marker_body_93"); // Box 307 glowey marker
		bodyModel[94] = new ModelRendererTurbo(this, 1, 65, textureX, textureY, "marker").setLightFixtureId("marker_body_94"); // Box 308 glowey marker
		...
		bodyModel[127] = new ModelRendererTurbo(this, 39, 54, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_127"); // Box 117 numberboard
		bodyModel[128] = new ModelRendererTurbo(this, 39, 54, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_128"); // Box 118 numberboard
		...
		bodyModel[136] = new ModelRendererTurbo(this, 493, 152, textureX, textureY, "marker").setLightFixtureId("marker_body_136"); // Box 339 glowey marker
		bodyModel[137] = new ModelRendererTurbo(this, 493, 152, textureX, textureY, "marker").setLightFixtureId("marker_body_137"); // Box 340 glowey marker
		...
		bodyModel[148] = new ModelRendererTurbo(this, 500, 152, textureX, textureY, "marker").setLightFixtureId("marker_body_148"); // Box 339 glowey marker
		bodyModel[149] = new ModelRendererTurbo(this, 500, 152, textureX, textureY, "marker").setLightFixtureId("marker_body_149"); // Box 340 glowey marker
		...
		bodyModel[158] = new ModelRendererTurbo(this, 481, 109, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_158"); // Box 165 numberboard
		bodyModel[159] = new ModelRendererTurbo(this, 481, 109, textureX, textureY, "numberboard").setLightFixtureId("numberboard_body_159"); // Box 167 numberboard
		...
		bodyModel[268] = new ModelRendererTurbo(this, 8, 59, textureX, textureY, "marker").setLightFixtureId("marker_highhood_bit_body_268"); // Box 307 glowey marker highhood bit
		bodyModel[269] = new ModelRendererTurbo(this, 8, 59, textureX, textureY, "marker").setLightFixtureId("marker_highhood_bit_body_269"); // Box 308 glowey marker highhood bit
		bodyModel[270] = new ModelRendererTurbo(this, 37, 62, textureX, textureY); // Box 402 highhood bit sandcap
		bodyModel[271] = new ModelRendererTurbo(this, 8, 50, textureX, textureY, "numberboard").setLightFixtureId("numberboard_high_hood_body_271"); // Box 388 numberboard highhood bit
		bodyModel[272] = new ModelRendererTurbo(this, 8, 50, textureX, textureY, "numberboard").setLightFixtureId("numberboard_high_hood_body_272"); // Box 389 numberboard highhood bit
		...
		bodyModel[362] = new ModelRendererTurbo(this, 55, 188, textureX, textureY, "instrument").setLightFixtureId("cab_speedometer_body_362"); // Box 275 cs speedo glow
